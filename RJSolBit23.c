...
#endif
#define ERI(X) (g[w[X][6]] | g[w[X][7]]) & (g[w[X][12]] | g[w[X][13]]) & \
...
static const int b[512] = {  // Bitwise to digit Cell Clues
  ...
  {62,71,80, 8,17,26,35,44,53,60,61,69,70,78,79}},
           W[16][2] = {      // References used for Basic, Hybrid and Transport Wings
  {14,12}, { 0,14}, { 6,20}, { 6,12}, { 7,13}, { 3,17},
  { 8, 6}, { 9, 8}, {12,10}, {10, 7}, {11, 9}, {13,11},
  { 8, 9}, {10,11}, { 1, 3}, {511,133955584}};

#if RJ > 2
static const char *S[81] = { // Either rYcX or A1-I9 Cell coordinates
...
int solve (int p)
{
  ...
  for (; y < 27; ++y)        // Search Naked/Hidden Tuples Cell Clues for each Unit
  {
    ...
    for (a = 0; a < 36; ++a) // Search Naked/Hidden pair Cell Clues for each Unit 36 pair Cell positions
    {
      ...
      if (B[K[0]] == 2)      // Check Naked pair Cell Clues in Unit pair Cell positions
      {
        ...
        g[l[y][h[a][8]]] &= ~K[0];
#if RJ > 2
        printf ("%d) Naked pair: %s %d Cells %s %s => -%d @ %s %s %s %s %s %s %s\n",
          p, RCB, LBN (l[y][h[a][0]]), S[l[y][h[a][0]]], S[l[y][h[a][1]]], b[K[0]], S[l[y][h[a][2]]],
          S[l[y][h[a][3]]], S[l[y][h[a][4]]], S[l[y][h[a][5]]], S[l[y][h[a][6]]], S[l[y][h[a][7]]], S[l[y][h[a][8]]]);
#endif
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Naked pair: %s %d Cells %s %s <= +%d @ %s %s %s %s %s %s %s\n",
          p, RCB, LBN (l[y][h[a][0]]), S[l[y][h[a][0]]], S[l[y][h[a][1]]], b[K[0]], S[l[y][h[a][2]]],
          S[l[y][h[a][3]]], S[l[y][h[a][4]]], S[l[y][h[a][5]]], S[l[y][h[a][6]]], S[l[y][h[a][7]]], S[l[y][h[a][8]]]);
#endif
        g[l[y][h[a][2]]] = k[0];
        ...
        prn ();
#endif
        return 0;            // Undo Naked pair Cell Clues to Unit other Cell positions
      }
      if (B[K[0] &= K[0] ^ K[1]] != 2)
      ...
      prn ();
#endif
      return 0;              // Undo other than Hidden pair Cell Clues to Unit pair Cell positions
    }
    if (Y > 4)
    ...
    for (; a < 120; ++a)     // Search Naked/Hidden triplet Cell Clues for each Unit 84 triplet Cell positions
    {
      ...
      if (B[K[0]] == 3)      // Check Naked triplet Cell Clues in Unit triplet Cell positions
      {
        ...
        g[l[y][h[a][8]]] &= ~K[0];
#if RJ > 2
        printf ("%d) Naked triplet: %s %d Cells %s %s %s => -%d @ %s %s %s %s %s %s\n",
          p, RCB, LBN (l[y][h[a][0]]), S[l[y][h[a][0]]], S[l[y][h[a][1]]], S[l[y][h[a][2]]], b[K[0]],
          S[l[y][h[a][3]]], S[l[y][h[a][4]]], S[l[y][h[a][5]]], S[l[y][h[a][6]]], S[l[y][h[a][7]]], S[l[y][h[a][8]]]);
#endif
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Naked triplet: %s %d Cells %s %s %s <= +%d @ %s %s %s %s %s %s\n",
          p, RCB, LBN (l[y][h[a][0]]), S[l[y][h[a][0]]], S[l[y][h[a][1]]], S[l[y][h[a][2]]], b[K[0]],
          S[l[y][h[a][3]]], S[l[y][h[a][4]]], S[l[y][h[a][5]]], S[l[y][h[a][6]]], S[l[y][h[a][7]]], S[l[y][h[a][8]]]);
#endif
        g[l[y][h[a][3]]] = k[0];
        ...
        prn ();
#endif
        return 0;            // Undo Naked triplet Cell Clues to Unit other Cell positions
      }
      if (B[K[0] &= K[0] ^ K[1]] != 3)
      ...
      prn ();
#endif
      return 0;              // Undo other than Hidden triplet Cell Clues to Unit triplet Cell positions
    }
    if (Y > 2)
    ...
    for (; a < 246; ++a)     // Search Naked/Hidden quad Cell Clues for each Unit 126 quad Cell positions
    {
      ...
      if (B[K[0]] == 4)      // Check Naked quad Cell Clues in Unit quad Cell positions
      {
        ...
        g[l[y][h[a][8]]] &= ~K[0];
#if RJ > 2
        printf ("%d) Naked quad: %s %d Cells %s %s %s %s => -%d @ %s %s %s %s %s\n",
          p, RCB, LBN (l[y][h[a][0]]), S[l[y][h[a][0]]], S[l[y][h[a][1]]], S[l[y][h[a][2]]], S[l[y][h[a][3]]],
          b[K[0]], S[l[y][h[a][4]]], S[l[y][h[a][5]]], S[l[y][h[a][6]]], S[l[y][h[a][7]]], S[l[y][h[a][8]]]);
#endif
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Naked quad: %s %d Cells %s %s %s %s <= +%d @ %s %s %s %s %s\n",
          p, RCB, LBN (l[y][h[a][0]]), S[l[y][h[a][0]]], S[l[y][h[a][1]]], S[l[y][h[a][2]]], S[l[y][h[a][3]]],
          b[K[0]], S[l[y][h[a][4]]], S[l[y][h[a][5]]], S[l[y][h[a][6]]], S[l[y][h[a][7]]], S[l[y][h[a][8]]]);
#endif
        g[l[y][h[a][4]]] = k[0];
        ...
        prn ();
#endif
        return 0;            // Undo Naked quad Cell Clues to Unit other Cell positions
      }
      if (B[K[0] &= K[0] ^ K[1]] != 4)
      ...
      prn ();
#endif
      return 0;              // Undo other than Hidden quad Cell Clues to Unit quad Cell positions
    }
  }
  for (a = 0; a < 54; ++a)   // Search Locked Clue for 54 Box-Line 3 Cell positions
    for (Y = g[j[a][0]] | g[j[a][1]] | g[j[a][2]]; y = Y & -Y; Y -= y)
                             // Search Box-Line 3 Cell positions for each Locked Clue
      if ((Z = (g[j[a][3]] | g[j[a][4]] | g[j[a][5]] | g[j[a][6]] | g[j[a][7]] | g[j[a][8]]) & y) !=
                             // Check Locked Clue in either Line other Cell positions; or
        ((g[j[a][9]] | g[j[a][10]] | g[j[a][11]] | g[j[a][12]] | g[j[a][13]] | g[j[a][14]]) & y))
      {                      // Locked Clue in Box other Cell positions
        int k[6] = {g[j[a][Z ? 3 : 9]], g[j[a][Z ? 4 : 10]], g[j[a][Z ? 5 : 11]],
                   g[j[a][Z ? 6 : 12]], g[j[a][Z ? 7 : 13]], g[j[a][Z ? 8 : 14]]};
                             // Backup and drop Locked Clue from Line / Box other Cell positions
        g[j[a][Z ? 3 : 9]] &= ~y;
        g[j[a][Z ? 4 : 10]] &= ~y;
        g[j[a][Z ? 5 : 11]] &= ~y;
        g[j[a][Z ? 6 : 12]] &= ~y;
        ...
        g[j[a][Z ? 8 : 14]] &= ~y;
#if RJ > 2
        printf ("%d) Locked candidate Type %sing): Cells %s %s %s => -%d @ %s %s %s %s %s %s\n",
          p, Z ? "1 (Point" : "2 (Claim", S[j[a][0]], S[j[a][1]], S[j[a][2]], b[y], S[j[a][Z ? 3 : 9]], S[j[a][Z ? 4 : 10]],
          S[j[a][Z ? 5 : 11]], S[j[a][Z ? 6 : 12]], S[j[a][Z ? 7 : 13]], S[j[a][Z ? 8 : 14]]);
#endif
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Locked candidate Type %sing): Cells %s %s %s <= +%d @ %s %s %s %s %s %s\n",
          p, Z ? "1 (Point" : "2 (Claim", S[j[a][0]], S[j[a][1]], S[j[a][2]], b[y], S[j[a][Z ? 3 : 9]], S[j[a][Z ? 4 : 10]],
          S[j[a][Z ? 5 : 11]], S[j[a][Z ? 6 : 12]], S[j[a][Z ? 7 : 13]], S[j[a][Z ? 8 : 14]]);
#endif
        g[j[a][Z ? 3 : 9]] = k[0];
        ...
        prn ();
#endif
        return 0;            // Undo Locked Clue to Line other Cell positions
      }
  for (y = 0; y < 10; y += 9)// Search Basic Fishes Line wise
    ...
    {                        // Search Basic Fishes for each digit
      ...
      {                      // Search X-Wing Clue for Line 36 pair Cell positions
        ...
        prn ();
#endif
        return 0;            // Undo X-Wing Clue to opposite Lines other Cell positions
      }
      for (; a < 120; ++a)   // Search Sword Fish Clue in Line 84 triplet Cell positions
      {
        ...
        prn ();
#endif
        return 0;            // Undo Sword Fish Clue to opposite Lines other Cell positions
      }
      for (; a < 246; ++a)   // Search Jelly Fish Clue in Line 126 quad Cell positions
      {
        ...
        prn ();
#endif
        return 0;            // Undo Jelly Fish Clue to opposite Lines other Cell positions
      }
    }
  ...
  for (a = 0; a < 81; ++a)   // Search 2-String Kite and Grouped 2-String Kite Grid wise
  {
    ...
    {                        // Search 2-String Kite and Grouped 2-String Kite digit wise
...
#if RJ > 2
      printf ("%d)%s2-String Kite: Strong Link Row %d between Cell",
        p, ((g[w[a][6]] & g[w[a][7]]) | (g[w[a][12]] & g[w[a][13]])) & Y ? " Grouped " : " ", b[(w[a][20] >> 18) & 511]);
      ...
      printf (" and Cell %s => -%d @ %s\n",
        S[w[a][13 + b[~K[1] & 63]]], b[Y], S[K[2]]);
#endif
      if (solve (p))
        return 1;
#if RJ > 2
      printf ("%d) Undo%s2-String Kite: Strong Link Row %d between Cell",
        p, ((g[w[a][6]] & g[w[a][7]]) | (g[w[a][12]] & g[w[a][13]])) & Y ? " Grouped " : " ", b[(w[a][20] >> 18) & 511]);
      if (g[w[a][6]] & g[w[a][7]] & Y)
        printf ("s %s %s", S[w[a][6]], S[w[a][7]]);
      else
        ...
        {                    // Search Strong Link 1st Cell position Line wise
          ...
          {                  // No ERI digit in five Line Cell positions
            ...
            {                // Dual Linked Empty Rectangle exclusions
              ...
              g[w[K[6]][W[4][!y]]] &= ~K[1];
#if RJ > 2
              printf ("%d) Dual Linked Empty Rectangle: Box %d Cell %s Box %d Cell %s Strong Link %s %d between Cell %s and Cell %s => -%d @ %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s\n",
                p, BOX (a), S[a], BOX (K[7]), S[K[7]], R_C, RCN (K[2]), S[K[2]], S[w[K[2]][W[1][y] + b[~K[3] & 63] - 1]],
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo Dual Linked Empty Rectangle: Box %d Cell %s Box %d Cell %s Strong Link %s %d between Cell %s and Cell %s <= +%d @ %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s\n",
                p, BOX (a), S[a], BOX (K[7]), S[K[7]], R_C, RCN (K[2]), S[K[2]], S[w[K[2]][W[1][y] + b[~K[3] & 63] - 1]],
                b[K[1]], S[K[7]], S[w[K[7]][K[5]]], S[w[K[7]][K[5] + 1]], S[w[K[7]][K[5] + 2]],
                S[a], S[w[a][K[4]]], S[w[a][K[4] + 1]], S[w[a][K[4] + 2]],
                S[w[a][K[5]]], S[w[a][K[5] + 1]], S[w[a][K[5] + 2]], S[w[K[2]][W[3][!y]]],
              ...
              prn ();
#endif
              return 0;      // Undo Dual Linked Empty Rectangle exclusion Cell Clues
            }
            if (!(g[K[7]] & K[1]))
              continue;      // Skip for no Empty Rectangle exclusion
#if RJ > 2
            printf ("%d) Empty Rectangle: Box %d Cell %s Strong Link %s %d between Cell %s and Cell %s => -%d @ %s\n",
              p, BOX (a), S[a], R_C, RCN (K[2]), S[K[2]],
            ...
            if (solve (p))
              return 1;
#if RJ > 2
            printf ("%d) Undo Empty Rectangle: Box %d Cell %s Strong Link %s %d between Cell %s and Cell %s <= +%d @ %s\n",
              p, BOX (a), S[a], R_C, RCN (K[2]), S[K[2]],
              S[w[K[2]][W[1][y] + b[~K[3] & 63] - 1]], b[K[1]], S[K[7]]);
            if (!(g[w[K[7]][W[3][!y]]] & K[1]) + !(g[w[K[7]][W[4][!y]]] & K[1]) +
              !(g[w[K[7]][W[1][!y]]] & K[1]) + !(g[w[K[7]][W[1][!y] + 1]] & K[1]) +
            ...
            {                // Check one ERI digit in 2nd Line Cell positions
              printf ("%d) Undo Empty Rectangle: Box %d Cell %s Strong Link %s %d between Cell %s and Cell %s <= +%d @ %s\n",
                ...
                S[w[K[2]][W[1][y] + b[~K[3] & 63] - 1]], b[K[1]], S[K[2]]);
              g[K[2]] |= K[1];
            }                // Undo ERI Strong Link digit to Line Cell position
#endif
            g[K[7]] |= K[1];
#if RJ > 3
            prn ();
#endif
            return 0;        // Undo ERI Strong Link digit to Line Cell position
          }
          if (!(ERI (K[2]) & K[1]))
          ...
          K[7] = a - K[2] + K[4];
          if (ERI (K[7]) &   // Check Grouped Linked Empty Rectangle Intersection Cell Clues; and
          ...
          {                  // Grouped Linked Empty Rectangle Intersection exclusions
            int k[17] = {g[a], g[w[a][K[5]]], g[w[a][K[5] + 1]], g[w[a][K[5] + 2]],
                        ...
                        g[K[7]], g[w[a][K[6]]], g[w[a][K[6] + 1]], g[w[a][K[6] + 2]]};
                             // Backup Grouped Linked Empty Rectangle exclusion Cells Clues and drop ERI digit
            g[a] &= ~K[1];
            g[w[a][K[5]]] &= ~K[1];
            g[w[a][K[5] + 1]] &= ~K[1];
            g[w[a][K[5] + 2]] &= ~K[1];
            ...
            g[w[a][K[6] + 2]] &= ~K[1];
#if RJ > 2
            printf ("%d) Grouped Linked Empty Rectangle: Box %d Cell %s Box %d Cell %s\nStrong Link %s %d between ERI Box %d Cell %s and ERI Box %d Cell %s => -%d @ %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s\n",
              p, BOX (a), S[a], BOX (K[7]), S[K[7]], R_C, RCN (K[2]), BOX (K[2]), S[K[2]], BOX (K[4]), S[K[4]],
            ...
            if (solve (p))
              return 1;
#if RJ > 2
            printf ("%d) Undo Grouped Linked Empty Rectangle: Box %d Cell %s Box %d Cell %s\nStrong Link %s %d between ERI Box %d Cell %s and ERI Box %d Cell %s <= +%d @ %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s\n",
              p, BOX (a), S[a], BOX (K[7]), S[K[7]], R_C, RCN (K[2]), BOX (K[2]), S[K[2]], BOX (K[4]), S[K[4]],
              b[K[1]], S[a], S[w[a][K[5]]], S[w[a][K[5] + 1]], S[w[a][K[5] + 2]],
              S[K[2]], S[w[K[2]][K[6]]], S[w[K[2]][K[6] + 1]], S[w[K[2]][K[6] + 2]],
              S[K[4]], S[w[K[7]][K[5]]], S[w[K[7]][K[5] + 1]], S[w[K[7]][K[5] + 2]],
          ...
          g[K[7]] &= ~K[1];  // Drop ERI Strong Link digit from Line Cell position
#if RJ > 2
          printf ("%d) Grouped Empty Rectangle: Box %d Cell %s Strong Link %s %d between ERI Box %d Cell %s and ERI Box %d Cell %s => -%d @ %s\n",
            p, BOX (a), S[a], R_C, RCN (K[2]), BOX (K[2]), S[K[2]], BOX (K[4]), S[K[4]], b[K[1]], S[K[7]]);
#endif
          if (solve (p))
            return 1;
#if RJ > 2
          printf ("%d) Undo Grouped Empty Rectangle: Box %d Cell %s Strong Link %s %d between ERI Box %d Cell %s and ERI Box %d Cell %s <= +%d @ %s\n",
            p, BOX (a), S[a], R_C, RCN (K[2]), BOX (K[2]), S[K[2]], BOX (K[4]), S[K[4]], b[K[1]], S[K[7]]);
#endif
          g[K[7]] |= K[1];
#if RJ > 3
    ...
    {                        // Search W-Wing Type 1 and Type 2 2nd Cell position unsolved Cell position wise
      ...
      {                      // Check 1st and 2nd Cell positions either Band or Stack wise
        ...
        {                    // (Type 2 01, 02) Check Strong Link either Line or Box wise
          ...
          g[K[8]] &= ~K[2];
#if RJ > 2
          printf ("%d) W-Wing Type 2 %s: %d @ %s %s Strong Link %s %d between Cells %s %s %s and Cells %s %s %s Clue %d\n=> -%d @ %s %s %s %s %s %s\n",
            p, A[2][0] ? "Stack" : "Band", b[g[K[0]]], S[K[0]], S[K[1]], K[9] ? (A[2][0] ? "Column" : "Row") : "Box",
            N ? b[(A[2][0] ? w[L][20] : w[L][20] >> 18) & 511] : BOX (L),
            S[X], S[w[X][W[3][A[2][0]]]], S[w[X][W[4][A[2][0]]]], S[Z], S[w[Z][W[3][A[2][0]]]],
            S[w[Z][W[4][A[2][0]]]], b[K[9]], b[K[2]], S[K[3]], S[K[5]], S[K[6]], S[K[4]], S[K[7]], S[K[8]]);
#endif
          if (solve (p))
            return 1;
#if RJ > 2
          printf ("%d) Undo W-Wing Type 2 %s: %d @ %s %s Strong Link %s %d between Cells %s %s %s and Cells %s %s %s Clue %d\n<= +%d @ %s %s %s %s %s %s\n",
            p, A[2][0] ? "Stack" : "Band", b[g[K[0]]], S[K[0]], S[K[1]], K[9] ? (A[2][0] ? "Column" : "Row") : "Box",
            N ? b[(A[2][0] ? w[L][20] : w[L][20] >> 18) & 511] : BOX (L),
            S[X], S[w[X][W[3][A[2][0]]]], S[w[X][W[4][A[2][0]]]], S[Z], S[w[Z][W[3][A[2][0]]]],
            S[w[Z][W[4][A[2][0]]]], b[K[9]], b[K[2]], S[K[3]], S[K[5]], S[K[6]], S[K[4]], S[K[7]], S[K[8]]);
          ...
          prn ();
#endif
          return 0;          // Undo W-Wing Type 2 exclusion Cells Clues
        }
      }
        ...
        {                    // Search W-Wing Type 1 Strong Link Wings wise
          for (K[6] = 0; K[6] < 2; ++K[6])
            for (K[7] = 0; K[7] < 2; ++K[7])
              ...
              {              // (Type 1 01) Check Strong Link Line wise
                ...
                g[K[4]] &= ~K[2];
#if RJ > 2
                printf ("%d) W-Wing Type 1 Grid: %d @ %s %s Strong Link %s %d between Cells %s %s %s and Cell %s Clue %d\n=> -%d @ %s %s\n",
                  p, b[g[K[0]]], S[K[0]], S[K[1]], K[6] ? "Column" : "Row",
                  b[(K[6] ? w[K[8]][20] : w[K[8]][20] >> 18) & 511], S[K[8]], S[w[K[8]][W[3][K[6]]]],
                  S[w[K[8]][W[4][K[6]]]], S[K[9]], b[N], b[K[2]], S[K[3]], S[K[4]]);
#endif
                if (solve (p))
                  return 1;
#if RJ > 2
                printf ("%d) Undo W-Wing Type 1 Grid: %d @ %s %s Strong Link %s %d between Cells %s %s %s and Cell %s Clue %d\n<= +%d @ %s %s\n",
                  p, b[g[K[0]]], S[K[0]], S[K[1]], K[6] ? "Column" : "Row",
                  b[(K[6] ? w[K[8]][20] : w[K[8]][20] >> 18) & 511], S[K[8]], S[w[K[8]][W[3][K[6]]]],
                  S[w[K[8]][W[4][K[6]]]], S[K[9]], b[N], b[K[2]], S[K[3]], S[K[4]]);
#endif
                ...
                prn ();
#endif
                return 0;    // Undo W-Wing Type 1 exclusion Cells Clues
              }
          ...
          {                  // (Type 1 02) Check Strong Link ERI wise
            ...
            g[K[4]] &= ~K[2];
#if RJ > 2
            printf ("%d) W-Wing Type 1 Grid: %d @ %s %s Strong Link ERI Box %d Cell %s Clue %d\n=> -%d @ %s %s\n",
              p, b[g[K[0]]], S[K[0]], S[K[1]], BOX (K[3 + a]), S[K[3 + a]], b[N], b[K[2]], S[K[3]], S[K[4]]);
#endif
            if (solve (p))
              return 1;
#if RJ > 2
            printf ("%d) Undo W-Wing Type 1 Grid: %d @ %s %s Strong Link ERI Box %d Cell %s Clue %d\n<= +%d @ %s %s\n",
              p, b[g[K[0]]], S[K[0]], S[K[1]], BOX (K[3 + a]), S[K[3 + a]], b[N], b[K[2]], S[K[3]], S[K[4]]);
#endif
            g[K[3]] = k[0];
            g[K[4]] = k[1];
      ...
      for (a = A[2][0]; a <= A[2][1]; ++a)
        ...
        {                    // Search W-Wing Type 1 and Type 2 Strong Link Line and ERI wise
          ...
          {                  // (Type 1 03, 04, Type 2 03, 04) Check Strong Link either Line or ERI wise
...
#if RJ > 2
            printf ("%d) W-Wing Type %s: %d @ %s %s Strong Link %s between ",
              p, A[2][0] != A[2][1] ? "1 Grid" : A[2][0] ? "2 Stack" : "2 Band",
              b[g[K[0]]], S[K[0]], S[K[1]], N ? (A[2][0] ? "Column" : "Row") : "ERI");
            if (!N)
              printf ("Box %d ", BOX (X));
            printf ("Cell %s and ", S[X]);
            if (!N)
              printf ("Box %d ", BOX (Z));
            printf ("Cell %s Clue %d\n=> -%d @ %s ",
              S[Z], b[K[9]], b[K[2]], S[K[3]]);
            if (K[5] + 1)
              ...
              if (solve (p))
                return 1;
#if RJ > 2
            printf ("%d) Undo W-Wing Type %s: %d @ %s %s Strong Link %s between ",
              p, A[2][0] != A[2][1] ? "1 Grid" : A[2][0] ? "2 Stack" : "2 Band",
              b[g[K[0]]], S[K[0]], S[K[1]], N ? (A[2][0] ? "Column" : "Row") : "ERI");
            if (!N)
              printf ("Box %d ", BOX (X));
            ...
            prn ();
#endif
            return 0;        // Undo W-Wing Type 1 and Type 2 exclusion Cells Clues
          }
        }
    }
  }
  for (a = p; a < q; ++a)    // Search XY-Ring Type 1, XY-Wing Type 1, XY-Wing Type 1 Transport and XYZ-Transport Apex Cell unsolved Cell position wise
  {
    ...
    for (; K[1] < 6; ++K[1]) // Search 1st Wing Cell position Row wise
    {
      ...
      {                      // Search 2nd Wing Cell position Column wise
        if (B[g[K[4] = w[K[0]][K[3]]]] != 2 || B[g[K[0]] | g[K[4]]] != 3)
          continue;          // Skip for either 2nd Wing Cell Clues not two digits; or Apex and 2nd Wing Cells Clues not three digits
        K[6] = K[2] - K[0] + K[4];
        if (K[2] > K[0] && K[4] > K[0] &&
                             // Check XY-Ring Type 1 1st Wing Cell position > Apex Cell position; and 2nd Wing Cell position > Apex Cell position; and
          B[g[K[0]]] == 2 && B[g[K[2]] | g[K[4]]] == 4 &&
                             // Apex Cell Clues two digits; and 1st and 2nd Wing Cells Clues three digits; and
          B[g[K[6]]] == 2 && B[g[K[2]] | g[K[6]]] == 3 &&
                             // 3rd Wing Cell Clues two digits; and 1st and 3rd Wing Cells Clues three digits; and 2nd and 3rd Wing Cells Clues three digits; and
          B[g[K[4]] | g[K[6]]] == 3 && B[g[K[0]] | g[K[6]]] == 4 &&
                             // Apex and 3rd Wing Cells Clues four digits; and
        ...
        {                    // XY-Ring Type 1 exclusion Cell Clues
          int k[28] = {g[w[K[0]][6]], g[w[K[0]][7]], g[w[K[2]][6]], g[w[K[2]][7]],
                       ...
                       g[w[K[2]][K[7]]], g[w[K[2]][K[7] + 1]], g[w[K[2]][K[7] + 2]]};
                             // Backup XY-Ring Type 1 exclusion Cell Clues and drop Wing Cells common exclusion Clues
          ...
          prn ();
#endif
          return 0;          // Undo Wing Cells common Clue to XY-Ring Type 1 exclusion Cell Clues
        }
        if (B[g[K[0]] | g[K[2]] | g[K[4]]] != 3 ||
                             // Skip for either Apex and Wings Cells Clues not three digits; or
          B[K[5] = g[K[2]] & g[K[4]]] != 1)
        ...
        {                    // Check XY-Wing Type 1 exclusion Cell Clues
          ...
          prn ();
#endif
          return 0;          // Undo Wing Cells common Clue to XY-Wing Type 1 exclusion Cell Clues
        }
        ...
        {                    // Check XYZ-Hybrid Apex Cell Clues > two digits; and Wing Cells common Clue in Hybrid Cell Clues
          int k[14] = {-1,-1};

          if ((g[w[K[0]][6]] | g[w[K[0]][7]] | g[w[K[2]][6]] | g[w[K[2]][7]] |
            g[w[K[0]][K[7]]] | g[w[K[0]][K[7] + 1]] |g[w[K[0]][K[7] + 2]]) &
                             // Check Wing Cells common Clue in Apex and 1st Wing Cells Row exclusion Cells Clues; and
              ~(g[w[K[2]][12]] | g[w[K[2]][13]] | g[w[K[6]][12]] | g[w[K[6]][13]] |
              g[w[K[2]][K[8]]] | g[w[K[2]][K[8] + 1]] | g[w[K[2]][K[8] + 2]]) & K[5])
          {                  // Wing Cells common Clue not in 1st Wing and Hybrid Cells Column other Cells Clues
            k[0] = g[w[K[0]][6]];
            k[2] = g[w[K[0]][7]];
            k[3] = g[w[K[2]][6]];
            k[4] = g[w[K[2]][7]];
          ...
          if ((g[w[K[0]][12]] | g[w[K[0]][13]] | g[w[K[4]][12]] | g[w[K[4]][13]] |
              g[w[K[0]][K[8]]] | g[w[K[0]][K[8] + 1]] | g[w[K[0]][K[8] + 2]]) &
                             // Check Wing Cells common Clue in Apex and 2nd Wing Cells Column exclusion Cells Clues; and
            ~(g[w[K[4]][6]] | g[w[K[4]][7]] | g[w[K[6]][6]] | g[w[K[6]][7]] |
            g[w[K[4]][K[7]]] | g[w[K[4]][K[7] + 1]] |g[w[K[4]][K[7] + 2]]) & K[5])
          {                  // Wing Cells common Clue not in Apex and 2nd Wing Cells Row other Cells Clues
            k[1] = g[w[K[0]][12]];
            k[8] = g[w[K[0]][13]];
            k[9] = g[w[K[4]][12]];
            k[10] = g[w[K[4]][13]];
          ...
          {
#if RJ > 2
            printf ("%d) XYZ-Hybrid: %d @ %s %s %s Hybrid%s%s%wise d @ %s\n=> -%d @",
              p, b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], k[0] + 1 ? " Column" : " ",
              k[1] + 1 ? (k[0] + 1 ? " and Row " : "Row ") : " ", b[K[5]], S[K[6]], b[K[5]]);
            if (k[0] + 1)
            ...
            if (solve (p))
              return 1;
#if RJ > 2
            printf ("%d) Undo XYZ-Hybrid: %d @ %s %s %s Hybrid%s%swise %d @ %s\n<= +%d @",
              p, b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], k[0] + 1 ? " Column" : " ",
              k[1] + 1 ? (k[0] + 1 ? " and Row " : "Row ") : " ", b[K[5]], S[K[6]], b[K[5]]);
            if (k[0] + 1)
              printf (" %s %s %s %s %s %s %s",
            ...
            prn ();
#endif
            return 0;        // Undo XYZ-Hybrid exclusion Cell Clues
          }
        }
        continue;
XYWT1Tf:
...
#if RJ > 2
        printf ("%d) XY%sTransport: %s Ring %d @ %s %s %s\nStrong Link Clue %d between Cell%s%s",
          p, B[g[K[0]]] < 3 ? "-Wing Type 1 " : "Z-",
          k[5] + 1 ? (k[5] ? "Line" : "ERI") : (k[4] + 1 ? "Line Reduced" : "Line"),
          b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], b[K[5]], A[0][1] + 1 ? "s " : " ", S[A[0][0]]);
        if (A[0][1] + 1)
        {
          printf (" %s", S[A[0][1]]);
          if (A[0][2] + 1)
        ...
        printf (" and Cell%s%s", A[1][1] + 1 ? "s " : " ", S[A[1][0]]);
        if (A[1][1] + 1)
        {
          printf (" %s", S[A[1][1]]);
          if (A[1][2] + 1)
        ...
        if (k[2] + 1)
        {
          ...
          if (k[4] + 1)
          {
            printf (" %s %s %s %s %s %s", S[k[4]], S[k[6]], S[k[7]], S[k[8]], S[k[9]], S[k[10]]);
            if (k[35] + 1)
            {
              printf (" %s", S[k[35]]);
              if (k[36] + 1)
              {
                printf (" %s", S[k[36]]);
                if (k[39] + 1)
                  printf (" %s %s %s %s", S[k[39]], S[k[40]], S[k[41]], S[k[42]]);
                if (k[49] + 1)
                  printf (" %s", S[k[49]]);
              }
            }
        ...
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo XY%sTransport: %s Ring %d @ %s %s %s\nStrong Link Clue %d between Cell%s%s",
          p, B[g[K[0]]] < 3 ? "-Wing Type 1 " : "Z-",
          k[5] + 1 ? (k[5] ? "Line" : "ERI") : (k[4] + 1 ? "Line Reduced" : "Line"),
          b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], b[K[5]], A[0][1] + 1 ? "s " : " ", S[A[0][0]]);
        if (A[0][1] + 1)
        ...
        prn ();
#endif
        return 0;            // Undo XY-Wing Type 1 Transport and XYZ-Transport exclusion Cell Clues
      }
    }
  }
  for (a = p; a < q; ++a)    // Search XY-Ring Type 2, XY-Wing Type 2, XY-Wing Type 2 Transport, XYZ-Wing, XYZ-Wing Transport and XYZ-Wing Hybrid Apex unsolved Cell position wise
  {
    if (B[g[r[a]]] > 3)
    ...
    for (y = 0; y < 2; ++y)  // Search Wing Cells position Chute wise
    {
      ...
      {                      // Search 1st Wing Cell position Line wise
        if (B[g[K[2] = w[K[0]][K[1]]]] != 2 || B[g[K[0]] | g[K[2]]] != 3)
          continue;          // Skip for either 1st Wing Cell position not two digits; or Apex and 1st Wing Cells Clues not three digits
        ...
        {                    // Search 2nd Wing Cell position Box wise but not 1st Wing Line
          ...
          if (K[2] > K[0] && K[4] > K[0] &&
            ...
            B[g[K[0]]] == 2 && B[g[K[2]] | g[K[4]]] == 4)
                             // Apex Cell Clues two digits; and 1st and 2nd Wing Cells Clues four digits
            for (Y = K[6]; Y < K[6] + 3; ++Y)
            {                // Search XY-Ring Type 2 3rd Wing Cell positio n 1st and 2nd Wing Cells common Cell positions wise
              if (B[g[K[5] = w[K[4]][Y]]] != 2 || B[g[K[2]] | g[K[5]]] != 3 ||
                             // Skip for either 3rd Wing Cell Clues not two digits; or 1st and 3rd Wing Cells Clues not three digits; or
                B[g[K[4]] | g[K[5]]] != 3 || B[g[K[0]] | g[K[5]]] != 4 ||
                             // 2nd and 3rd Wing Cells Clues three not digits; or Apex and 3rd Wing Cells Clues not four digits; or
                ...
                continue;    // no XY-Ring Type 2 exclusion Cell Clues
              int k[32] = {g[w[K[0]][W[3][y]]], g[w[K[0]][W[4][y]]],
                           ...
                           g[w[Z][W[3][y]]], g[w[Z][W[4][y]]],-1,-1};
                             // Backup XY-Ring Type 2 exclusion Cell Clues and drop Wing Cells common exclusion Clues
              g[w[K[0]][W[3][y]]] &= ~g[K[0]];
              g[w[K[0]][W[4][y]]] &= ~g[K[0]];
              g[w[K[2]][W[3][y]]] &= ~g[K[2]];
              g[w[K[2]][W[4][y]]] &= ~g[K[2]];
              ...
              printf ("%d) XY-Ring Type 2: %d @ %s %s %s %s\n=> -%d @ %s %s %s %s %s %s %s => -%d @ %s %s %s %s %s %s %s\n=> -%d @ %s %s %s %s %s %s %s",
                ...
                b[g[K[0]] & g[K[4]]], S[w[K[0]][W[3][y]]],
                S[w[K[0]][W[4][y]]], S[w[K[4]][W[3][y]]],
                S[w[K[4]][W[4][y]]], S[w[K[0]][K[8]]],
              ...
              prn ();
#endif
              return 0;      // Undo Wing Cells common Clue to XY-Ring Type 2 exclusion Cell Clues
            }
          if (B[g[K[0]] | g[K[2]] | g[K[4]]] > 3 ||
                             // Skip for either Apex Cell and Wing Cells Clues > three digits; or
            B[K[5] = g[K[2]] & g[K[4]]] != 1 ||
                             // Wing Cells common Clue not one digit; or
            ((g[K[0]] & K[5]) && B[g[K[0]]] != 3))
            continue;        // Wing Cells common Clue in Apex Cell Clues; and Apex Cell Clues not three digits
          int k[5] = {g[w[K[0]][W[3][y]]], g[w[K[0]][W[4][y]]]};
                             // Backup XY-Wing Type 2 and XYZ-Wing exclusion Cells Clues
          if (~g[K[0]] & K[5])
          ...
          {                  // Check Wing Cells common Clue in XY-Wing Type 2 and XYZ-Wing exclusion Cells Clues
            ...
            g[w[K[0]][W[4][y]]] = k[1];
            if (~g[K[0]] & K[5])
            {                // Undo Wing Cells common Clue to XY-Wing Type 2 more exclusion Cell positions
              g[w[K[4]][K[6]]] = k[2];
              g[w[K[4]][K[6] + 1]] = k[3];
              g[w[K[4]][K[6] + 2]] = k[4];
            }
            ...
            prn ();
#endif
            return 0;        // Undo XY-Wing Type 2 and XYZ-Wing exclusion Cells Clues
          }
...
XYWT2Tf:
            ...
            prn ();
#endif
            return 0;        // Undo XY-Wing Type 2 Transport exclusion Cell Clues
          }
          {                  // XYZ-Wing Transport
            int k[76] = {-1,-1,-1,-1,-1,-1};
            ...
            {                // (Line 01, Box 02)
              ...
              g[w[M][W[4][y]]] &= ~K[5];
#if RJ > 2
              printf ("%d) XYZ-Wing Transport: %s %d @ %s %s %s Strong Link %s %d => -%d @ %s %s %s\n",
                p, k[75] ? R_C : "Box", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], k[75] ? R_C : "Box",
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo XYZ-Wing Transport: %s %d @ %s %s %s Strong Link %s %d <= +%d @ %s %s %s\n",
                p, k[75] ? R_C : "Box", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], k[75] ? R_C : "Box",
                k[75] ? RCN (w[K[4]][K[7]]) : BOX (w[K[4]][K[7]]), b[K[5]],
                S[M], S[w[M][W[3][y]]], S[w[M][W[4][y]]]);
#endif
              ...
              prn ();
#endif
              return 0;      // Undo XYZ-Wing Transport exclusion Cell Clues
            }
            if (((k[75] = LB3 (M = w[K[4]][N], w[M][K[1]], w[M][K[7]], y) & K[5]) ||
              (LB3 (w[K[0]][K[7]], w[K[4]][K[7]], w[X][K[8]], y) & K[5])) &&
              (((g[w[K[2]][W[3][y]]] | g[w[K[2]][W[4][y]]] | g[w[K[4]][W[3][y]]] |
            ...
            {                // (Line Ring 03, Box Ring 04, Line Reduced Ring 05, 06, 07)
              ...
              g[w[M][W[4][y]]] &= Y;
#if RJ > 2
              printf ("%d) XYZ-Wing Transport: %s%sRing %d @ %s %s %s\nStrong Link %s %d => -%d @ %s %s %s %s %s %s %s",
                p, k[75] ? R_C : "Box", k[15] ? " Reduced " : " ", b[g[K[0]]],
                S[K[0]], S[K[2]], S[K[4]], k[75] ? R_C : "Box", k[75] ? RCN (M) : BOX (M),
            ...
            for (Y = W[1][!y]; Y < W[2][!y]; ++Y)
            {
              ...
              {              // (Line Ring 08, 10, ERI Ring 09, 11)
...
#if RJ > 2
                printf ("%d) XYZ-Wing Transport: %s Ring %d @ %s %s %s\nStrong Link %s %d between Cell %s and Cell %s => -%d @ %s",
                  p, k[75] ? R_C : "ERI", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], k[75] ? R_C : "ERI",
                  k[75] ? RCN (X) : BOX (X), S[X], S[Z], b[K[5]], S[M]);
                if (w[K[0]][K[8]] == M)
                {
                  if (k[75])
                    ...
                    printf (" %s %s %s %s %s", S[X], S[Z], S[w[Z][K[7]]], S[w[w[Z][K[7]]][W[3][y]]], S[w[w[Z][K[7]]][W[3][y]]]);
                ...
                printf ("\n=> -%d @ %s %s %s %s %s %s %s => -%d @ %s %s %s %s %s %s %s\n",
                  ...
                  if (solve (p))
                    return 1;
#if RJ > 2
                printf ("%d) Undo XYZ-Wing Transport: %s Ring %d @ %s %s %s\nStrong Link %s %d between Cell %s and Cell %s <= +%d @ %s",
                  p, k[75] ? R_C : "ERI", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], k[75] ? R_C : "ERI",
                  k[75] ? RCN (X) : BOX (X), S[X], S[Z], b[K[5]], S[M]);
                if (w[K[0]][K[8]] == M)
                {
              ...
              for (A = K[7]; A < K[7] + 3; ++A)
                ...
                {            // (Line 12, ERI 13, 14)
...
#if RJ > 2
                  printf ("%d) XYZ-Wing Transport: %s %d @ %s %s %s Strong Link %s %d => -%d @ %s",
                    p, k[75] ? R_C : "ERI", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]],
                  ...
                  if (solve (p))
                    return 1;
#if RJ > 2
                  printf ("%d) Undo XYZ-Wing Transport: %s %d @ %s %s %s Strong Link %s %d <= +%d @ %s",
                    p, k[75] ? R_C : "ERI", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]],
                    k[75] ? R_C : "ERI Box", k[75] ? RCN (X) : BOX (X), b[K[5]], S[L]);
                  if (k[1] + 1)
                    printf (" %s", S[w[K[2]][Y]]);
              ...
              for (M = 0; M < 2; ++M)
              {
                for (A = 3; A < 5; ++A)
                  ...
                  {          // (Line 15, 17, 19, 21 ERI 16, 18, 20, 22)
...
#if RJ > 2
                    printf ("%d) XYZ-Wing Transport: %s %d @ %s %s %s Strong Link %s %d between Cell %s and Cell %s\n=> -%d @ %s",
                      p, k[75] ? R_C : "ERI", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], k[75] ? R_C : "ERI",
                      k[75] ? RCN (X) : BOX (X), S[X], S[Z], b[g[K[0]]], S[L]);
                    if (k[1] + 1)
                    {
                    ...
                    if (solve (p))
                      return 1;
#if RJ > 2
                    printf ("%d) Undo XYZ-Wing Transport: %s %d @ %s %s %s Strong Link %s %d between Cell %s and Cell %s\n<= +%d @ %s",
                      p, k[75] ? R_C : "ERI", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], k[75] ? R_C : "ERI",
                      k[75] ? RCN (X) : BOX (X), S[X], S[Z], b[g[K[0]]], S[L]);
                    if (k[1] + 1)
                    {
                ...
                {            // (ERI 24, 25)
                  g[w[K[4 >> M]][Y]] &= ~K[5];
#if RJ > 2
                  printf ("%d) XYZ-Wing Transport: ERI %d @ %s %s %s Strong Link ERI Box %d Cell %s => -%d @ %s\n",
                      p, b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], BOX (w[K[2 << M]][Y]), S[w[K[2 << M]][Y]], b[K[5]], S[w[K[4 >> M]][Y]]);
#endif
                  if (solve (p))
                    return 1;
#if RJ > 2
                  printf ("%d) Undo XYZ-Wing Transport: ERI %d @ %s %s %s Strong Link ERI Box %d Cell %s <= +%d @ %s\n",
                      p, b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], BOX (w[K[2 << M]][Y]), S[w[K[2 << M]][Y]], b[K[5]], S[w[K[4 >> M]][Y]]);
#endif
                  g[w[K[4 >> M]][Y]] |= K[5];
#if RJ > 3
          ...
          {                  // Check Wing Cells common Clue in XYZ-Wing Hybrid Cells Clues
            int k[6] = {-1,-1};

            if (~(g[w[K[2]][W[3][y]]] | g[w[K[2]][W[4][y]]] |
              g[Z = w[K[2]][K[8]]] | g[w[Z][W[3][y]]] | g[w[Z][W[4][y]]]) &
              (g[w[K[0]][K[7]]] | g[w[K[0]][K[7] + 1]] | g[w[K[0]][K[7] + 2]]) & K[5])
            {                // Backup XYZ-Wing Hybrid Box wise and exclude Wing Cells common Clue from exclusion Cells Clues
              k[0] = g[w[K[0]][K[7]]];
			  k[2] = g[w[K[0]][K[7] + 1]];
			  k[3] = g[w[K[0]][K[7] + 2]];
              g[w[K[0]][K[7]]] &= ~K[5];
            ...
            if (~(g[w[K[4]][W[3][y]]] | g[w[K[4]][W[4][y]]] |
              g[w[K[4]][K[7]]] | g[w[K[4]][K[7] + 1]] | g[w[K[4]][K[7] + 2]]) &
              (g[Z = w[K[0]][K[8]]] | g[w[Z][W[3][y]]] | g[w[Z][W[4][y]]]) & K[5])
            {                // Backup XYZ-Wing Hybrid Line wise and exclude Wing Cells common Clue from exclusion Cells Clues
              k[1] = g[Z];
			  k[4] = g[w[Z][W[3][y]]];
			  k[5] = g[w[Z][W[4][y]]];
              g[Z] &= ~K[5];
            ...
            {
#if RJ > 2
              printf ("%d) XYZ-Wing Hybrid: %d @ %s %s %s Hybrid%s%swise %d @ %s %s %s => -%d @",
                p, b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], k[0] + 1 ? " Box" : " ",
                k[1] + 1 ? (k[0] + 1 ? " and Box " : "Box ") : " ",
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo XYZ-Wing Hybrid: %d @ %s %s %s Hybrid%s%swise %d @ %s %s %s <= +%d @",
                p, b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], k[0] + 1 ? " Box" : " ",
                k[1] + 1 ? (k[0] + 1 ? " and Box " : "Box ") : " ",
                b[K[5]], S[w[K[4]][K[6]]], S[w[K[4]][K[6] + 1]], S[w[K[4]][K[6] + 2]], b[K[5]]);
              if (k[0] + 1)
              ...
              prn ();
#endif
              return 0;        // Undo XYZ-Wing Hybrid exclusion Cells Clues
            }
          }
        }
      }
  ...
  for (a = p; a < q; ++a)    // Search WXYZ-Wing Type 1 and Almost Locked Set Type 1a Apex unsolved Cell position wise
  {
      ...
      {                      // Search 2nd Wing Cell position Column wise but not both Wings in Apex Box
        ...
        {                    // Search 3rd Wing Cell position Line wise
          if ((!Y && K[3] < 14) || (Y && K[1] > 5) || B[g[K[4 >> Y]]] > 2)
            continue;        // Skip for either 2nd (or 1st) Wing Cell position within chute; or 2nd (or 1st) Wing Cell Clues > two digits
          ...
          {                  // Search 3rd Wing Cell position
            ...
            {                // Check no Wing Cells common Clue in WXYZ-Wing Type 1 exclusion Cell Clues
              ...
              if (k[5] + 1)
              {
                ...
                printf ("%s\n", S[K[8]]);
#endif
              if (k[5] + 1)  // Undo Wing Cells common Clue to WXYZ-Wing Type 1 exclusion Cell positions
              {
                g[w[K[0]][W[3][k[5]]]] = k[3];
                g[w[K[0]][W[4][k[5]]]] = k[4];
                if (~g[K[0]] & K[7])
              ...
              prn ();
#endif
              return 0;      // Undo Wing Cells common Clue to WXYZ-Wing Type 1 exclusion Cell Clues
            }
// WXYZ-Wing Type 1 Transport
          }
        }
        if (K[1] < 6 && K[3] > 13 &&
                             // Check Almost Locked Set Type 1a 1st Wing Cell position not Apex Box; and 2nd Wing Cell position not Apex Box; and
          B[g[K[0]]] == 3 && B[g[K[2]]] == 2 && B[g[K[4]]] == 2 &&
                             // Apex Cell Clues three digits; and 1st Wing Cell Clues two digits; and 2nd Wing Cell Clues two digits; and
          B[g[K[2]] | g[K[4]]] == 4 && B[g[K[5] = K[2] - K[0] + K[4]]] == 2 &&
                             // 1st and 2nd Wing Cells Clues three digits; and 3rd Wing Cell Clues two digits; and
          B[g[K[2]] | g[K[5]]] == 3 && B[g[K[4]] | g[K[5]]] == 3 &&
                             // 1st and 3rd Wing Cells Clues three digits; and 2nd and 3rd Wing Cells Clues three digits; and
          B[g[K[0]] | g[K[5]]] == 4 &&
                             // Apex and 3rd Wing Cells Clues four digits; and
        ...
        {                    // Almost Locked Set Type 1a exclusion Cell Clues
          int k[7] = {g[w[K[0]][W[3][Y]]], g[w[K[0]][W[4][Y]]],
                      g[w[y][W[3][Y]]], g[w[y][W[4][Y]]],
                      g[w[K[0]][Z]], g[w[K[0]][Z + 1]], g[w[K[0]][Z + 2]]};
                             // Backup Almost Locked Set Type 1a exclusion Cell Clues and drop Wing Cells common exclusion Clues
          g[w[K[0]][W[3][Y]]] &= ~K[6];
          g[w[K[0]][W[4][Y]]] &= ~K[6];
          g[w[y][W[3][Y]]] &= ~K[6];
          g[w[y][W[4][Y]]] &= ~K[6];
          ...
          g[w[K[0]][Z + 2]] &= ~K[6];
#if RJ > 2
          printf ("%d) Almost Locked Set Type 1a: %d @ %s %s %s %s => -%d @ %s %s %s %s %s %s %s\n",
            p, b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], S[K[5]],
          ...
          if (solve (p))
            return 1;
#if RJ > 2
          printf ("%d) Undo Almost Locked Set Type 1a: %d @ %s %s %s %s <= +%d @ %s %s %s %s %s %s %s\n",
            p, b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], S[K[5]],
            b[K[6]], S[w[K[0]][W[3][Y]]], S[w[K[0]][W[4][Y]]],
            S[w[y][W[3][Y]]], S[w[y][W[4][Y]]],
            S[w[K[0]][Z]], S[w[K[0]][Z + 1]], S[w[K[0]][Z + 2]]);
          ...
          prn ();
#endif
          return 0;          // Undo Wing Cells common Clue to Almost Locked Set Type 1a exclusion Cell Clues
        }
      }
    }
  }
          ...
          for (Y = 0; Y < 2; ++Y)
            ...
            {                // Search 3rd Wing Cell position
              ...
              {              // Check WXYZ-Wing Type 2a, Type 2b and Type 3 exclusion Cells Clues
...
#if RJ > 2
                if (A[0] + 1)
                  printf ("%d) WXYZ-Wing Type 2a: %d @ %s %s %s %s => -%d @ %s %s %s %s %s\n",
                    p, b[g[K[0]] | g[K[2]] | g[K[4]] | g[K[6]]], S[K[0]], S[K[2]], S[K[4]], S[K[6]],
                    b[K[7]], S[w[K[0]][W[3][y]]], S[w[K[0]][W[4][y]]], S[w[A[0]][A[1]]], S[w[A[0]][A[1] + 1]], S[w[A[0]][A[1] + 2]]);
                else
                  printf ("%d) WXYZ-Wing Type %s: %d @ %s %s %s %s => -%d @ %s %s\n",
                    p, g[K[0]] & K[7] ? "3" : "2b", b[g[K[0]] | g[K[2]] | g[K[4]] | g[K[6]]],
...
#if RJ > 2
                if (A[0] + 1)
                  printf ("%d) Undo WXYZ-Wing Type 2a: %d @ %s %s %s %s <= +%d @ %s %s %s %s %s\n",
                    p, b[g[K[0]] | g[K[2]] | g[K[4]] | g[K[6]]], S[K[0]], S[K[2]], S[K[4]], S[K[6]],
                    b[K[7]], S[w[K[0]][W[3][y]]], S[w[K[0]][W[4][y]]], S[w[A[0]][A[1]]], S[w[A[0]][A[1] + 1]], S[w[A[0]][A[1] + 2]]);
                else
                ...
                prn ();
#endif
                return 0;    // Undo WXYZ-Wing Type 2a, Type 2b and Type 3 exclusion Cells Clues
              }
...
// WXYZ-Wing Type 2a, Type 2b and Type 3 Transport
          ...
          {                  // Search 2nd Apex Cell position mini-Line wise
            ...
            {                // Check WXYZ-Wing Type 4a and Type 4b exclusion Cells Clues
              ...
              prn ();
#endif
              return 0;      // Undo WXYZ-Wing Type 4a and Type 4b exclusion Cells Clues
            }
          }
        }
      }
...
NHSCF:
  ...
  {                          // Backup and clear current Cell Clues and assign current Cell position to each current Cell Clue
    ...
    printf ("\n");
#endif
    while (a)                // Undo current Cell Clue to 20 peer Cell positions
      if (Z & (1 << --a))
        g[w[r[p]][a]] |= s[r[p]];
#if RJ > 3
    g[r[p]] = Y;             // Undo current Cell Clues to current Cell position
    prn ();
  ...
  if (y == 2)
    --n[3];
  g[r[p]] = Y;
  return 0;                  // Undo current Cell Clues to current Cell position
}
