...
static int b[512] = {        // Bitwise to digit Cell Values
  ...
  { 8, 6}, {14,12}, { 0,14}, { 6,20}, { 6,12}, { 7,13}, { 3,17}, { 8, 6},
  { 9, 8}, {12,10}, {10, 7}, {11, 9}, {13,11}, { 0, 0}, { 0, 0}, { 0, 0}};
...
int solve (int p)
{
  ...
  for (a = p; a < q; ++a)    // Search XY-Wings Type 1 and XY-Wings Transport Type 1 unsolved Cell position wise
  {
    if (B[g[r[a]]] != 2 &&   // Skip for unsolved Cell Values not two digits; and
      ...
      continue;              // Pivot Row and Column not contain unsolved Cell position
    int K[9] = {r[a], 0};    // Assign Pivot Cell position

    for (; K[1] < 6; ++K[1]) // Search first Pincer Cell position Row wise
    {
      ...
      {                      // Search second Pincer Cell position Column wise
        if (B[g[K[4] = w[K[0]][K[3]]]] != 2 ||
                             // Skip for second Pincer Cell Values not two digits; or
          B[K[5] = g[K[2]] & g[K[4]]] != 1 ||
                             // Pincer Cells common Value not one digit; or
          g[K[0]] & K[5] ||  // Pivot and Pincer Cells common Value; or
          B[g[K[0]] | g[K[2]] | g[K[4]]] != 3)
          continue;          // Combined Pivot and Pincer Cells Values not three digits
        if (g[K[6] = K[2] - K[0] + K[4]] & K[5])
        {                    // Search XY-Wings Type 1 elimination Cell Values
          g[K[6]] &= ~K[5];  // Remove Pincer Cells common Value from XY-Wings Type 1 elimination Cell position
#if RJ > 2
          ...
          printf ("%d) Restore XY-Wings Type 1 in Cells %d %d %d Values %d add %d to Cell %d\n",
            a, K[0], K[2], K[4], b[g[K[2]] | g[K[4]]], b[K[5]], K[6]);
#endif
          g[K[6]] |= K[5];   // Restore Pincer Cells common Value to XY-Wings Type 1 elimination Cell Values
#if RJ > 3
          prn ();
#endif
          return 0;
        }
                             // XY-Wings Transport Type 1
        int k[7] = {-1,-1,-1,-1};

        K[7] = K[1] < 3 ? 3 : 0;
        K[8] = K[3] < 17 ? 17 : 14;
        if ((g[Y = w[K[0]][K[7]]] | g[Y + 1] | g[Y + 2]) & K[5])
        {                    // Check Pincer cells common Value found in Pivot and first Pincer common row but not box
          if ((g[w[K[0]][y = 12]] & (g[w[Y][8]] | g[w[Y][9]] | g[w[Y][12]]) &
            ~(g[w[Y][10]] | g[w[Y][11]] | g[w[Y][13]]) & K[5]) ||
            (g[w[K[0]][++y]] & ~(g[w[Y][8]] | g[w[Y][9]] | g[w[Y][12]]) &
            (g[w[Y][10]] | g[w[Y][11]] | g[w[Y][13]]) & K[5]))
                             // Check Pincer cells common Value found in one row of box within band neither Pivot and first Pincer common row nor box (05, 09)
            k[0] = w[K[0]][y];
...
if ((k[0] & k[1]) < 0)
{
        ...
        {                    // Check Pincer cells common Value found in Pivot and second Pincer common line but not box
          if ((g[w[K[0]][y = 6]] & (g[w[Y][6]] | g[w[Y][8]] | g[w[Y][10]]) &
            ~(g[w[Y][7]] | g[w[Y][9]] | g[w[Y][11]]) & K[5]) ||
            (g[w[K[0]][++y]] & ~(g[w[Y][6]] | g[w[Y][8]] | g[w[Y][10]]) &
            (g[w[Y][7]] | g[w[Y][9]] | g[w[Y][11]]) & K[5]))
                             // Check Pincer cells common Value found in line of box within chute neither Pivot and first Pincer common line nor box (06, 10)
            k[0] = w[K[0]][y];
...
if ((k[0] & k[1]) < 0)
{
        ...
        {                    // Check Pincer cells common Value found in second Pincer and elimination common row but not box
          if ((g[w[K[6]][y = 12]] & (g[w[Y][8]] | g[w[Y][9]] | g[w[Y][12]]) &
            ~(g[w[Y][10]] | g[w[Y][11]] | g[w[Y][13]]) & K[5]) ||
            (g[w[K[6]][++y]] & ~(g[w[Y][8]] | g[w[Y][9]] | g[w[Y][12]]) &
            (g[w[Y][10]] | g[w[Y][11]] | g[w[Y][13]]) & K[5]))
                             // Check Pincer cells common Value found in one row of box within band neither Pivot and first Pincer common row nor box (07, 11)
            k[0] = w[K[6]][y];
...
if ((k[0] & k[1]) < 0)
{
        ...
        {                    // Check Pincer cells common Value found in first Pincer and elimination common line but not box
          if ((g[w[K[6]][y = 6]] & (g[w[Y][6]] | g[w[Y][8]] | g[w[Y][10]]) &
            ~(g[w[Y][7]] | g[w[Y][9]] | g[w[Y][11]]) & K[5]) ||
            (g[w[K[6]][++y]] & ~(g[w[Y][6]] | g[w[Y][8]] | g[w[Y][10]]) &
            (g[w[Y][7]] | g[w[Y][9]] | g[w[Y][11]]) & K[5]))
                             // Check Pincer Cells common Value found in one row of box within band neither Pivot and Pincer common row nor box (08, 12)
            k[0] = w[K[6]][y];
...
prn();
          ...
          if (k[1] > -1)
            g[k[1]] &= ~K[5];
//#if RJ > 2
          printf ("%d) Found XY-Wings Transport Type 1 %s in Cells %d %d %d %d Values %d remove %d from Cell",
...
//#endif
          if (solve (p))
            return 1;
//#if RJ > 2
          printf ("%d) Restore XY-Wings Transport Type 1 %s in Cells %d %d %d %d Values %d add %d to Cell",
            a, k[0] > -1 && k[1] < 0 ? "Box" : (k[0] | k[1]) < 0 ? "ERI" : "Reduced ERI",
            K[0], K[2], K[4], K[6], b[g[K[2]] | g[K[4]]], b[K[5]]);
          if ((k[0] | k[1]) < 0)
            printf (" %d\n", k[0] + k[1] + 1);
        ...
        if ((g[w[K[2]][8]] | g[w[K[2]][9]] | g[w[K[2]][12]]) & K[5])
        {
          if ((g[w[K[0]][8]] | g[w[K[0]][9]] | g[w[K[0]][12]]) & K[5])
          {
            if (~(g[Y = w[w[K[0]][12]][K[7]]] | g[Y + 1] | g[Y + 2]) & K[5])
            {
              ...
              else if ((g[w[K[4]][y = 6]] | g[w[K[4]][8]] | g[w[K[4]][10]]) &
                g[w[K[0]][8]] & ~g[w[K[0]][9]] & K[5] ||
                (g[w[K[4]][y = 7]] | g[w[K[4]][9]] | g[w[K[4]][11]]) &
                ~g[w[K[0]][8]] & g[w[K[0]][9]] & K[5])
              {              // (21)
                k[0] = w[K[4]][y];
                k[1] = w[K[4]][y + 2];
        ...
        if ((g[w[K[4]][8]] | g[w[K[4]][9]] | g[w[K[4]][12]]) & K[5])
        {
          if ((g[w[K[6]][8]] | g[w[K[6]][9]] | g[w[K[6]][12]]) & K[5])
          {
            if (~(g[Y = w[w[K[4]][12]][K[7]]] | g[Y + 1] | g[Y + 2]) & K[5])
            {
              ...
              else if ((g[w[K[2]][y = 6]] | g[w[K[2]][8]] | g[w[K[2]][10]]) &
                g[w[K[6]][8]] & ~g[w[K[6]][9]] & K[5] ||
                (g[w[K[2]][y = 7]] | g[w[K[2]][9]] | g[w[K[2]][11]]) &
                ~g[w[K[6]][8]] & g[w[K[6]][9]] & K[5])
              {              // (19)
                k[0] = w[K[2]][y];
                k[1] = w[K[2]][y + 2];
...
//#if RJ > 2
          printf ("%d) Found XY-Wings Transport Type 1 Line in Cells %d %d %d %d Values %d remove %d from Cell",
            a, K[0], K[2], K[4], K[6], b[g[K[2]] | g[K[4]]], b[K[5]]);
          if (k[2] > -1)
            printf ("s");
          if (k[3] > -1)
            printf (" %d", k[3]);
...
//#endif
          if (solve (p))
            return 1;
//#if RJ > 2
          printf ("%d) Restore XY-Wings Transport Type 1 Line in Cells %d %d %d %d Values %d add %d to Cell",
            a, K[0], K[2], K[4], K[6], b[g[K[2]] | g[K[4]]], b[K[5]]);
          if (k[2] > -1)
            printf ("s");
          if (k[3] > -1)
  ...
  for (y = 0; y < 2; ++y)    // Search XY-Wings Type 2, XYZ-Wings and XYZ-Wings Hybrid Type 1 and Type 2 Chute wise
    for (a = p; a < q; ++a)  // Search unsolved Cell position wise
    {
      if (B[g[r[a]]] > 3 &&  // Skip for unsolved Cell Values more than three digits; and
        ...
        continue;            // Pivot Box and Line not contain unsolved Cell position
      int K[5] = {r[a], W[0][y]};
            ...
            {                // Search XY-Wings Type 2 eliminations Cell Values
              int k[5] = {g[w[K[0]][W[4][y]]], g[w[K[0]][W[5][y]]], g[w[w[K[0]][K[1]]][K[3]]],
                g[w[w[K[0]][K[1]]][K[3] + 1]], g[w[w[K[0]][K[1]]][K[3] + 2]]};
                             // Backup and remove Pincer Cells common Value from XY-Wings Type 2 elimination Cell positions
              g[w[K[0]][W[4][y]]] &= ~K[4];
              g[w[K[0]][W[5][y]]] &= ~K[4];
...
// XY-Wings Transport Type 2
          ...
          {                  // Search for XYZ-Wings elimination Cells Value
            int k[2] = {g[w[K[0]][W[4][y]]], g[w[K[0]][W[5][y]]]};
                             // Backup and remove Pincer Cells common Value from XYZ-Wings elimination Cell positions
            g[w[K[0]][W[4][y]]] &= ~K[4];
            g[w[K[0]][W[5][y]]] &= ~K[4];
#if RJ > 2
          ...
          {                  // Search XYZ-Wings Hybrid Type wise
            ...
            k[1] = g[w[K[0]][X[1]]];
            k[2] = g[w[K[0]][X[2]]];
                             // Backup and remove Pincer Cells common Value from XYZ-Wings Hybrid Type 1 and Type 2 elimination Cell positions
            g[w[K[0]][X[0]]] &= ~K[4];
            g[w[K[0]][X[1]]] &= ~K[4];
            g[w[K[0]][X[2]]] &= ~K[4];
#if RJ > 2
        ...
        for (y = 0; y < 1; ++y)
          ...
          {                  // Search third Pincer Cell position
            ...
            if (!g[w[K[0]][K[3]]] || B[g[w[K[0]][K[3]]]] > 3 ||
              ...
              continue;      // Pivot Cell Values and first (or second) Pincer Cell Values equals to Pivot Cell Values and third Pincer Cell Values; or
            if (K[4] & g[K[5]])
            {                // Search WXYZ-Wings Type 1 elimination Cell Values
                             // Remove Pincer Cells common Value from WXYZ-Wings Type 1 elimination Cell position
              g[K[5]] &= ~K[4];
#if RJ > 2
              ...
              prn ();
#endif
              return 0;      // Restore Pincer Cell common Value to WXYZ-Wings Type 1 elimination Cell Values
            }
// WXYZ-Wings Transport Type 1
          }
      }
    }
  }
          ...
          for (Y = 0; Y < 2; ++Y)
            ...
            {                // Search third Pincer Cell position
              ...
              {              // Search WXYZ-Wings Type 2a, Type 2b and Type 3 eliminations Cell Values
                             // Remove Pincer Cells common Value from WXYZ-Wings Type 2b and Type 3 elimination Cell positions
                g[w[K[0]][W[4][y]]] &= ~K[4];
                g[w[K[0]][W[5][y]]] &= ~K[4];
                if (X[0] > -1)
                {            // Remove Pincer Cells common Value from WXYZ-Wings Type 2a more elimination Cell positions
                  g[w[X[0]][X[1]]] &= ~K[4];
                  g[w[X[0]][X[1] + 1]] &= ~K[4];
                  g[w[X[0]][X[1] + 2]] &= ~K[4];
                }
...
// WXYZ-Wings Transport Type 2a, Type 2b and Type 3
            }
        }
      }
    }
