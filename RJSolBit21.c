  ...
  for (a = p; a < q; ++a)    // Search XY-Wing Type 1, XY-Wing Type 1 Transport and XYZ-Transport Apex Cell unsolved Cell position wise
  {
    ...
    for (; K[1] < 6; ++K[1]) // Search 1st Wing Cell position Row wise
    {
      ...
      {                      // Search 2nd Wing Cell position Column wise
        ...
        for (y = 0; y < 2; ++y)
        {
          if (LB3 (w[K[0]][12 + y], w[K[2]][12 + y], w[X][K[7]], 0) & K[5])
          ...
          if ((k[2] & k[3]) + 1)
            goto XYWT1Tf;
          if (LB3 (w[K[0]][6 + y], w[K[4]][6 + y], w[X][K[8]], 1) & K[5])
          {                  // (Line 14, 26, Line Reduced Ring 18, 22)
            if (g[w[K[0]][7 - y]] & K[5])
              k[3] = w[K[0]][7 - y];
#if RJ > 2
            A[0][0] = X;
          ...
          {                  // (Line 15, 27, Line Reduced Ring 19, 23)
            ...
            if ((~(g[w[X][6]] | g[w[X][7]]) & K[5]) &&
              ...
              (B[g[K[0]]] > 2 ? g[K[6]] | g[w[K[6]][13 - y]] :
              g[w[M][6]] | g[w[M][7]] | g[w[K[4]][6]] | g[w[K[4]][7]]) |
              ((g[w[Z][6]] | g[w[Z][7]]) & K[5] ? 0 :
          ...
          {                  // (Line 16, 28, Line Reduced Ring 20, 24)
...
XYWT1Tf:
        ...
        prn ();
#endif
        return 0;            // Restore XY-Wing Type 1 Transport and XYZ-Transport exclusion Cell Clues
      }
    }
  }
      ...
      {                      // Search 1st Wing Cell position Line wise
        ...
        {                    // Search 2nd Wing Cell position Box wise but not 1st Wing Line
          ...
          {                  // Wing Cells common Clue not in Apex Cell Clues
            ...
            if (((k[75] = LB3 (M = w[K[4]][N], w[M][K[1]], w[X][K[7]], y) & K[5]) ||
