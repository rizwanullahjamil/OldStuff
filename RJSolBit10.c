...
int solve (int p)
{
  ...
  {
    if (B[g[r[a]]] != 2 && !(g[w[r[a]][0]] | g[w[r[a]][1]] | g[w[r[a]][2]] |
    ...
    {
      K[2] = w[K[0]][K[1]];  // Assign first Pincer Cell position
      if (B[g[K[2]]] != 2 || B[g[K[0]] & g[K[2]]] != 1)
      ...
      {                      // Search second Pincer Cell position Column wise
        K[4] = w[K[0]][K[3]];// Assign second Pincer Cell position
        K[5] = K[2] - K[0] + K[4];
        ...
        if (B[g[K[4]]] != 2 ||
          ...
          B[K[6]] != 1 ||    // Pincer Cells common Value not one digit; or
          g[K[0]] & K[6] ||  // Pivot and Pincer Cells common Value; or
          B[g[K[0]] | g[K[2]] | g[K[4]]] != 3)
          continue;          // Combined Pivot and Pincer Cells Values not three digits
        if (g[K[5]] & K[6])  // Search XY-Wings Type 1 elimination Cell Values
        {
          g[K[5]] &= ~K[6];  // Remove Pincer Cells common Value from XY-Wings Type 1 elimination Cell position
#if RJ > 2
          printf ("%d) Found XY-Wings Type 1 in Cells %d %d %d Values %d remove %d from Cell %d\n",
            a, K[0], K[2], K[4], b[g[K[2]] | g[K[4]]], b[K[6]], K[5]);
#endif
          if (solve (p))
            return 1;
#if RJ > 2
          printf ("%d) Restore XY-Wings Type 1 in Cells %d %d %d Values %d add %d to Cell %d\n",
            a, K[0], K[2], K[4], b[g[K[2]] | g[K[4]]], b[K[6]], K[5]);
#endif
          g[K[5]] |= K[6];   // Restore Pincer Cells common Value to XY-Wings Type 1 elimination Cell Values
#if RJ > 3
          prn ();
#endif
          return 0;
...
/* XY-Wings Transport Type 1 */
        ...
        K[8] = K[3] < 17 ? 17 : 14;
        Y = -1;
        if ((g[y = w[K[0]][K[7]]] | g[y + 1] | g[y + 2]) & K[6])
        {                    // Check Pincer cells common Value found in Pivot and first Pincer common row but not box
          if ((g[w[K[0]][Y = 12]] & K[6] && (g[w[y][8]] | g[w[y][9]] | g[w[y][12]]) & K[6] &&
            !((g[w[y][10]] | g[w[y][11]] | g[w[y][13]]) & K[6])) ||
            (g[w[K[0]][++Y]] & K[6] && !((g[w[y][8]] | g[w[y][9]] | g[w[y][12]]) & K[6]) &&
            (g[w[y][10]] | g[w[y][11]] | g[w[y][13]]) & K[6]))
            y = w[K[0]][Y];  // Check Pincer cells common Value found in one row of box within band neither Pivot and Pincer common row nor box (05, 18)
          else
            y = -1;
          if ((g[(Y = w[K[0]][K[7]]) - K[0] + K[4]] & K[6] &&
            (g[Y] | g[w[Y][12]] | g[w[Y][13]]) & K[6] &&
            !((g[w[Y][8]] | g[w[Y][9]] | g[w[Y][10]] | g[w[Y][11]]) & K[6])) ||
            (g[++Y - K[0] + K[4]] & K[6] && (g[Y] | g[w[Y][12]] | g[w[Y][13]]) & K[6] &&
            !((g[w[Y][8]] | g[w[Y][9]] | g[w[Y][10]] | g[w[Y][11]]) & K[6])) ||
            (g[++Y - K[0] + K[4]] & K[6] && (g[Y] | g[w[Y][12]] | g[w[Y][13]]) & K[6] &&
            !((g[w[Y][8]] | g[w[Y][9]] | g[w[Y][10]] | g[w[Y][11]]) & K[6])))
            Y = Y - K[0] + K[4];
          ...
          y = -1;
        if (y < 0 && Y < 0 && (g[y = w[K[4]][K[7]]] | g[y + 1] | g[y + 2]) & K[6])
        {                    // Check Pincer cells common Value found in elimination and second Pincer common row but not box
          if ((g[w[K[5]][Y = 12]] & K[6] && (g[w[y][8]] | g[w[y][9]] | g[w[y][12]]) & K[6] &&
            !((g[w[y][10]] | g[w[y][11]] | g[w[y][13]]) & K[6])) ||
            (g[w[K[5]][++Y]] & K[6] && !((g[w[y][8]] | g[w[y][9]] | g[w[y][12]]) & K[6]) &&
            (g[w[y][10]] | g[w[y][11]] | g[w[y][13]]) & K[6]))
            y = w[K[5]][Y];  // Check Pincer Cells common Value found in one row of box within band neither Pivot and Pincer common row nor box (05, 18)
          else
            y = -1;
          if ((g[(Y = w[K[4]][K[7]]) - K[4] + K[0]] & K[6] &&
            (g[Y] | g[w[Y][12]] | g[w[Y][13]]) & K[6] &&
            !((g[w[Y][8]] | g[w[Y][9]] | g[w[Y][10]] | g[w[Y][11]]) & K[6])) ||
            (g[++Y - K[4] + K[0]] & K[6] && (g[Y] | g[w[Y][12]] | g[w[Y][13]]) & K[6] &&
            !((g[w[Y][8]] | g[w[Y][9]] | g[w[Y][10]] | g[w[Y][11]]) & K[6])) ||
            (g[++Y - K[4] + K[0]] & K[6] && (g[Y] | g[w[Y][12]] | g[w[Y][13]]) & K[6] &&
            !((g[w[Y][8]] | g[w[Y][9]] | g[w[Y][10]] | g[w[Y][11]]) & K[6])))
            Y = Y - K[4] + K[0];
...
prn ();
          ...
          if (Y > -1)
            g[Y] &= ~K[6];
//#if RJ > 2
          printf ("%d) Found XY-Wings Transport Type 1 %s in Cells %d %d %d Values %d remove %d from Cell",
            a, y > -1 && Y < 0 ? "Box" : "ER", K[0], K[2], K[4], b[g[K[2]] | g[K[4]]], b[K[6]]);
          if (y > -1 && Y > -1)
            printf ("s %d %d\n", y, Y);
          else
            printf (" %d\n", y + Y + 1);
...
//#endif
          if (solve (p))
            return 1;
//#if RJ > 2
          printf ("%d) Restore XY-Wings Transport Type 1 %s in Cells %d %d %d Values %d add %d to Cell",
            a, y > -1 && Y < 0 ? "Box" : "ER", K[0], K[2], K[4], b[g[K[2]] | g[K[4]]], b[K[6]]);
          if (y > -1 && Y > -1)
            printf ("s %d %d\n", y, Y);
          else
...
// XY-Wings Transport Type 2
          ...
          {                  // Search XYZ-Wings Hybrid Type wise
            ...
            if ((g[w[K[0]][K[Y + 1]]] != g[w[w[K[0]][K[1]]][L]] &&
              ...
              g[w[K[0]][K[Y + 1]]] != g[w[w[K[0]][K[1]]][++L]]) ||
              !(K[4] & (g[w[K[0]][X[0]]] | g[w[K[0]][X[1]]] | g[w[K[0]][X[2]]])))
...
// XYZ-Wings Transport
  ...
  for (a = p; a < q; ++a)    // Search WXYZ-Wings Type 1 unsolved Cell position wise
  {
    if (B[g[r[a]]] != 3 &&   // Skip for unsolved Cell Values not three digits; and
      ...
      (g[w[r[a]][0]] ? 1 : 0) + (g[w[r[a]][1]] ? 1 : 0) +
      (g[w[r[a]][2]] ? 1 : 0) + (g[w[r[a]][3]] ? 1 : 0) +
      (g[w[r[a]][4]] ? 1 : 0) + (g[w[r[a]][5]] ? 1 : 0) +
      (g[w[r[a]][14]] ? 1 : 0) + (g[w[r[a]][15]] ? 1 : 0) +
      (g[w[r[a]][16]] ? 1 : 0) + (g[w[r[a]][17]] ? 1 : 0) +
      (g[w[r[a]][18]] ? 1 : 0) + (g[w[r[a]][19]] ? 1 : 0) < 3)
...
// WXYZ-Wings Transport Type 1
  ...
  for (y = 0; y < 2; ++y)    // Search WXYZ-Wings Type 2a, Type 2b and Type 3 Chute wise
    for (a = p; a < q; ++a)  // Search unsolved Cell position wise
    {
      ...
      g[w[r[a]][W[0][y] + 3]] | g[w[r[a]][W[0][y] + 4]] | g[w[r[a]][W[0][y] + 5]]) &&
                             // Pivot Box not contain unsolved Cell position; and
      !(g[w[r[a]][W[2][y]]] | g[w[r[a]][W[2][y] + 1]] | g[w[r[a]][W[2][y] + 2]] |
      g[w[r[a]][W[2][y] + 3]] | g[w[r[a]][W[2][y] + 4]] | g[w[r[a]][W[2][y] + 5]]) &&
                             // Pivot Line not contain unsolved Cell position; and
...
/* WXYZ-Wings Hybrid Type 1 and Type 2
              for (Y = 0; Y < 2; ++Y)
              {              // Search WXYZ-Wings Hybrid Type wise
                int L,
                    X[3],
                    k[3];

                if (Y)
                {            // Search WXYZ-Wings Hybrid Type 1
                  X[0] = W[K[2] < W[6][y] ? 6 : 2][y];
                  X[1] = X[0] + 1;
                  X[2] = X[1] + 1;
                }
                else
                {            // Search WXYZ-Wings Hybrid Type 2
                  L = K[1] == W[7][y] || K[1] == W[8][y] || K[1] == W[9][y] ? 10 : 7;
                  X[0] = W[L][y];
                  X[1] = W[L + 1][y];
                  X[2] = W[L + 2][y];
                ...
                if ((g[w[K[0]][K[Y + 1]]] != g[w[w[K[0]][K[1]]][L]] &&
                  ...
                  g[w[K[0]][K[Y + 1]]] != g[w[w[K[0]][K[1]]][++L]]) ||
                  !(K[4] & (g[w[K[0]][X[0]]] | g[w[K[0]][X[1]]] | g[w[K[0]][X[2]]])))
                  continue;  // Skip for either WXYZ-Wings Hybrid Cell position not found or eliminations not found
                k[0] = g[w[K[0]][X[0]]];
                k[1] = g[w[K[0]][X[1]]];
                k[2] = g[w[K[0]][X[2]]];
                             // Backup and remove Pincer Cells common Value from WXYZ-Wings Hybrid Type 1 and Type 2 elimination Cell positions
                g[w[K[0]][X[0]]] &= ~K[4];
                g[w[K[0]][X[1]]] &= ~K[4];
                g[w[K[0]][X[2]]] &= ~K[4];
#if RJ > 2
                printf ("%d) Found WXYZ-Wings Hybrid Type %d in Cells %d %d %d %d Values %d remove %d from Cells %d %d %d\n",
                  a, 2 - Y, K[0], w[K[0]][K[1]], w[K[0]][K[2]], w[w[K[0]][K[1]]][L], b[g[K[0]]],
                  b[K[4]], w[K[0]][X[0]], w[K[0]][X[1]], w[K[0]][X[2]]);
#endif
                if (solve (p))
                  return 1;
#if RJ > 2
                printf ("%d) Restore WXYZ-Wings Hybrid Type %d in Cells %d %d %d %d Values %d add %d to Cells %d %d %d\n",
                  a, 2 - Y, K[0], w[K[0]][K[1]], w[K[0]][K[2]], w[w[K[0]][K[1]]][L], b[g[K[0]]],
                  b[K[4]], w[K[0]][X[0]], w[K[0]][X[1]], w[K[0]][X[2]]);
#endif
                g[w[K[0]][X[0]]] = k[0];
                ...
                prn ();
#endif
                return 0;    // Restore WXYZ-Wings Hybrid Type 1 and Type 2 elimination Cells Values
              }
*/
