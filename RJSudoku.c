...
START:
    ...
    {
      if ((Y = !G[I].g[l[y][0]] + !G[I].g[l[y][1]] + !G[I].g[l[y][2]] +
        !G[I].g[l[y][3]] + !G[I].g[l[y][4]] + !G[I].g[l[y][5]] +
        !G[I].g[l[y][6]] + !G[I].g[l[y][7]] + !G[I].g[l[y][8]]) > 6)
    ...
    for (y = 0; y < 10; y += 9)
      ...
      for (Y = 1; Y < 257; Y <<= 1)
        ...
        {                    // Search 1st SL within 1st and 2nd Chutes
          ...
          if ((A[6] = !(G[I].g[l[a][6]] & Y) + !(G[I].g[l[a][7]] & Y) +
            !(G[I].g[l[a][8]] & Y)) == 2)
          ...
          {                  // Search 2nd SL within 2nd and 3rd Chutes
            A[3] = A[4] = 0;
            A[5] = A[2];
            if ((A[6] = !(G[I].g[l[Z][0]] & Y) + !(G[I].g[l[Z][1]] & Y) +
              !(G[I].g[l[Z][2]] & Y)) == 2)
            ...
            if ((A[6] = !(G[I].g[l[Z][3]] & Y) + !(G[I].g[l[Z][4]] & Y) +
              !(G[I].g[l[Z][5]] & Y)) == 2)
            ...
            if ((A[6] = !(G[I].g[l[Z][6]] & Y) + !(G[I].g[l[Z][7]] & Y) +
              !(G[I].g[l[Z][8]] & Y)) == 2)
            {                // Found 2nd SL either one Cover or Base Cell position
              if (A[4] || ~A[1] & 4)
            ...
            if (A[0] & 1 && (!(G[I].g[l[a][0]] & Y) | (!(G[I].g[l[a][1]] & Y) << 1) |
              (!(G[I].g[l[a][2]] & Y) << 2)) == (!(G[I].g[l[Z][0]] & Y) |
              (!(G[I].g[l[Z][1]] & Y) << 1) | (!(G[I].g[l[Z][2]] & Y) << 2)))
              A[6] = 1;
            if ((A[0] | A[1]) & 2 && (!(G[I].g[l[a][3]] & Y) |
              (!(G[I].g[l[a][4]] & Y) << 1) | (!(G[I].g[l[a][5]] & Y) << 2)) ==
              (!(G[I].g[l[Z][3]] & Y) | (!(G[I].g[l[Z][4]] & Y) << 1) |
              (!(G[I].g[l[Z][5]] & Y) << 2)))
              A[6] |= 2;
            if (A[1] & 4 && (!(G[I].g[l[a][6]] & Y) | (!(G[I].g[l[a][7]] & Y) << 1) |
              (!(G[I].g[l[a][8]] & Y) << 2)) == (!(G[I].g[l[Z][6]] & Y) |
              (!(G[I].g[l[Z][7]] & Y) << 1) | (!(G[I].g[l[Z][8]] & Y) << 2)))
              A[6] |= 4;
            if (B[A[6]] != 1)
    ...
    {
      if (!(y = ~G[I].g[a] & (G[I].g[w[a][6]] | G[I].g[w[a][7]]) &
        (G[I].g[w[a][12]] | G[I].g[w[a][13]])))
      ...
      {                      // Search 2-String Kite and Grouped 2-String Kite with ERI Ring and ERI digit wise
        ...
        if ((G[I].g[L = w[K[3]][b[~Z & 63] > 3 ? 14 : 17]] | G[I].g[w[L][12]] |
          G[I].g[w[L][13]] | G[I].g[M = w[K[4]][b[~X & 63] > 3 ? 0 : 3]] |
          G[I].g[w[M][6]] | G[I].g[w[M][7]] | G[I].g[w[K[3]][12]] | G[I].g[w[K[3]][13]] |
          G[I].g[w[K[4]][6]] | G[I].g[w[K[4]][7]] | G[I].g[w[a][8]] | G[I].g[w[a][9]] |
          G[I].g[w[a][10]] | G[I].g[w[a][11]]) & ERI (K[5]) & Y)
        ...
        else if ((G[I].g[w[w[K[3]][6]][12]] | G[I].g[w[w[K[3]][6]][13]]) &
          ERI (w[K[5]][6]) & Y)
        ...
        else if ((G[I].g[w[w[K[3]][7]][12]] | G[I].g[w[w[K[3]][7]][13]]) &
          ERI (w[K[5]][7]) & Y)
        {                    // Check 2-String Kite+ERI and Grouped 2-String Kite+ERI
#if RJ > 2
        ...
        else if ((G[I].g[w[w[K[4]][12]][6]] | G[I].g[w[w[K[4]][12]][7]]) &
          ERI (w[K[5]][12]) & Y)
        {                    // Check 2-String Kite+ERI and Grouped 2-String Kite+ERI
#if RJ > 2
        ...
        else if ((G[I].g[w[w[K[4]][13]][6]] | G[I].g[w[w[K[4]][13]][7]]) &
          ERI (w[K[5]][13]) & Y)
        {                    // Check 2-String Kite+ERI and Grouped 2-String Kite+ERI
#if RJ > 2
        ...
        printf ("%d)%s2-String Kite%s SL Row %d between %d @ ", G[I].p,
          ((G[I].g[w[a][6]] & G[I].g[w[a][7]]) |
          (G[I].g[w[a][12]] & G[I].g[w[a][13]])) & Y ? " Grouped " : " ",
      ...
      for (; K[1] = K[0] & -K[0]; K[0] -= K[1])
        ...
        for (y = 0; y < 2; ++y)
          ...
          {                  // Search SL 1st Cell position Line wise
            if (G[I].g[K[2] = w[a][Y]] &
              ~(G[I].g[w[K[2]][W[3][y]]] | G[I].g[w[K[2]][W[4][y]]]) & K[1] &&
                             // Check ERI digit either in SL 1st Cell values; and not in mini-Line Cells values; and
              B[K[3] = !(G[I].g[w[K[2]][W[1][y]]] & K[1]) |
              (!(G[I].g[w[K[2]][W[18][y]]] & K[1]) << 1) |
              (!(G[I].g[w[K[2]][W[19][y]]] & K[1]) << 2) |
              (!(G[I].g[w[K[2]][W[20][y]]] & K[1]) << 3) |
              (!(G[I].g[w[K[2]][W[21][y]]] & K[1]) << 4) |
              (!(G[I].g[w[K[2]][W[22][y]]] & K[1]) << 5)] == 5)
            {                // No ERI digit found in six Line Cell positions
              ...
              if (ERI (K[7]) &
                ...
                (G[I].g[K[7]] | G[I].g[w[K[7]][K[5]]] | G[I].g[w[K[7]][K[5] + 1]] |
                G[I].g[w[K[7]][K[5] + 2]] | G[I].g[a] | G[I].g[w[a][K[4]]] |
                G[I].g[w[a][K[4] + 1]] | G[I].g[w[a][K[4] + 2]] |
              ...
              if (!(G[I].g[w[K[7]][W[3][!y]]] & K[1]) +
                !(G[I].g[w[K[7]][W[4][!y]]] & K[1]) +
                !(G[I].g[w[K[7]][W[1][!y]]] & K[1]) +
                !(G[I].g[w[K[7]][W[18][!y]]] & K[1]) +
                !(G[I].g[w[K[7]][W[19][!y]]] & K[1]) +
                !(G[I].g[w[K[7]][W[20][!y]]] & K[1]) +
                !(G[I].g[w[K[7]][W[21][!y]]] & K[1]) +
                !(G[I].g[w[K[7]][W[22][!y]]] & K[1]) == 7)
            ...
            if (ERI (K[7]) & // Check ERI digit found in Grouped Linked Empty Rectangle Intersection Cell values; and
              (G[I].g[a] | G[I].g[w[a][K[5]]] | G[I].g[w[a][K[5] + 1]] |
              G[I].g[w[a][K[5] + 2]] | G[I].g[K[2]] | G[I].g[w[K[2]][K[6]]] |
              G[I].g[w[K[2]][K[6] + 1]] | G[I].g[w[K[2]][K[6] + 2]] | G[I].g[K[4]] |
              G[I].g[w[K[7]][K[5]]] | G[I].g[w[K[7]][K[5] + 1]] |
              G[I].g[w[K[7]][K[5] + 2]] | G[I].g[K[7]] | G[I].g[w[a][K[6]]] |
              G[I].g[w[a][K[6] + 1]] | G[I].g[w[a][K[6] + 2]]) & K[1])
      ...
      {                      // Search W-Wing Type 1, Type 2 and W-Ring 2nd Wing Cell position unsolved Cell positions wise
        ...
        if ((w[K[0]][20] & W[25][0]) != (w[K[1]][20] & W[25][0]) &&
          ...
          {                  // Search W-Wing Type 1 SL Line wise
            for (K[6] = 0; K[6] < 2; ++K[6])
              for (K[7] = 0; K[7] < 2; ++K[7])
                if ((N = (G[I].g[K[8] = w[K[a]][W[3 + K[7]][!K[6]]]] |
                  ...
                  !(G[I].g[w[K[8]][W[19][K[6]]]] & N) +
                  !(G[I].g[w[K[8]][W[20][K[6]]]] & N) +
                  !(G[I].g[w[K[8]][W[21][K[6]]]] & N) +
                  !(G[I].g[w[K[8]][W[22][K[6]]]] & N) > 4 &&
            ...
            if ((N = ERI (K[3 + a]) & K[2]) && B[N] < 2 ?
              ...
              G[I].g[w[K[0]][W[3][a]]] | G[I].g[w[K[0]][W[4][a]]] | G[I].g[A[0]] |
              G[I].g[A[1]] | G[I].g[A[2]] | G[I].g[w[K[1]][W[3][!a]]] |
              G[I].g[w[K[1]][W[4][!a]]] | G[I].g[A[3]] | G[I].g[A[4]] | G[I].g[A[5]]) & N)
        ...
        {                    // Check W-Wing Type 2 1st and 2nd Wing Cells positions either Band or Stack wise
          ...
          if (((N = K[9] = LB3 (w[L][W[1][A[2][0]]], w[L][W[5][A[2][0]]], L, A[2][0]) & K[2]) ||
            ...
            (G[I].g[K[3]] | G[I].g[K[4]] | G[I].g[K[5]] | G[I].g[K[6]] | G[I].g[K[7]] |
            G[I].g[K[8]]) & (K[2] - K[9]))
        ...
        for (a = A[2][0]; a <= A[2][1]; ++a)
          ...
          {                  // Search W-Wing Type 1 and Type 2 SL Line and ERI wise
            if (((N = K[9] = LN1 (w[K[0]][L], w[K[3 + a]][L], w[X][A[0][!a]], a) & K[2]) ||
              ...
              (K[5] + 1 ? G[I].g[K[5]] | G[I].g[K[6]] | G[I].g[K[7]] | G[I].g[K[8]] : 0)) &
              (K[2] - K[9])) // (Type 1 03, 04, Type 2 03, 04) Check SL either Line or ERI wise
            {
              K[2] -= K[9];
              G[I].g[K[3]] &= ~K[2];
              G[I].g[K[4]] &= ~K[2];
    ...
    {                        // Search Strong Wing Type 1 and Strong Ring Type 1 Apex Cell unsolved Cell positions wise
      if (!(G[I].g[w[r[a]][0]] | G[I].g[w[r[a]][1]] | G[I].g[w[r[a]][2]] |
        G[I].g[w[r[a]][3]] | G[I].g[w[r[a]][4]] | G[I].g[w[r[a]][5]]) ||
      ...
      {                      // Search 1st Wing Cell position Row wise
        if (!(K[6] = G[I].g[K[0]] & G[I].g[K[2] = w[K[0]][K[1]]] & ~(G[I].g[w[K[0]][6]] |
          G[I].g[w[K[0]][7]] | G[I].g[w[K[2]][6]] | G[I].g[w[K[2]][7]] |
        ...
        {                    // Search 2nd Wing Cell position Column wise
          if (!(K[7] = G[I].g[K[0]] & G[I].g[K[4] = w[K[0]][K[3]]] &
            ~(G[I].g[w[K[0]][12]] | G[I].g[w[K[0]][13]] | G[I].g[w[K[4]][12]] |
            G[I].g[w[K[4]][13]] | G[I].g[Y = w[K[0]][Z = K[3] < 17 ? 17 : 14]] |
            G[I].g[w[Y][12]] | G[I].g[w[Y][13]])) ||
            ...
            !(K[8] = G[I].g[K[2]] & G[I].g[K[5] = w[K[4]][K[1]]] & ~(G[I].g[w[K[2]][12]] |
            G[I].g[w[K[2]][13]] | G[I].g[w[K[5]][12]] | G[I].g[w[K[5]][13]] |
            G[I].g[Y = w[K[2]][Z]] | G[I].g[w[Y][12]] | G[I].g[w[Y][13]])) ||
                             // No conjugate pair digit found in 1st Wing and removal Cells values; or
            !(K[9] = G[I].g[K[4]] & G[I].g[K[5]] & ~(G[I].g[w[K[4]][6]] |
            G[I].g[w[K[4]][7]] | G[I].g[w[K[5]][6]] | G[I].g[w[K[5]][7]] |
            G[I].g[Y = w[K[4]][X]] | G[I].g[w[Y][6]] | G[I].g[w[Y][7]])))
    ...
    {                        // Search Strong Wing Type 2 and Strong Ring Type 2 Apex Cell unsolved Cell positions wise
      ...
      {
        if (!(G[I].g[w[K[0]][W[1][y]]] | G[I].g[w[K[0]][W[18][y]]] |
          G[I].g[w[K[0]][W[19][y]]] | G[I].g[w[K[0]][W[20][y]]] |
          G[I].g[w[K[0]][W[21][y]]] | G[I].g[w[K[0]][W[22][y]]]) ||
          !(G[I].g[w[K[0]][W[6][y]]] | G[I].g[w[K[0]][W[7][y]]] |
          G[I].g[w[K[0]][W[8][y]]] | G[I].g[w[K[0]][W[9][y]]] |
          G[I].g[w[K[0]][W[10][y]]] | G[I].g[w[K[0]][W[11][y]]]))
        ...
        {                    // Search 1st Wing Cell position Line wise
          if (!(K[6] = G[I].g[K[0]] & G[I].g[K[2] = w[K[0]][K[1]]] &
            ~(G[I].g[w[K[0]][W[3][y]]] | G[I].g[w[K[0]][W[4][y]]] |
            G[I].g[w[K[2]][W[3][y]]] | G[I].g[w[K[2]][W[4][y]]] |
            G[I].g[Y = w[K[0]][K[11] = W[K[1] < W[5][y] ? 5 : 1][y]]] |
          ...
          {                  // Search 2nd Wing Cell position Box wise but not in 1st Wing Line
            if (!(K[7] = G[I].g[K[0]] & G[I].g[K[4] = w[K[0]][K[3]]] &
              ...
              G[I].g[Y = w[K[0]][Z = W[K[3] == W[6][y] || K[3] == W[7][y] ||
              K[3] == W[8][y] ? 4 : 3][!y]]] | G[I].g[w[Y][W[3][y]]] |
              G[I].g[w[Y][W[4][y]]])) ||
            ...
            {                // Search removal Cell position 1st Wing Line and 2nd Wing Box intersection wise
              if (!(K[8] = G[I].g[K[2]] & G[I].g[K[5] = w[K[4]][K[1]]] &
                ~(G[I].g[w[K[2]][W[3][y]]] | G[I].g[w[K[2]][W[4][y]]] |
                G[I].g[w[K[5]][W[3][y]]] | G[I].g[w[K[5]][W[4][y]]] |
                G[I].g[Y = w[K[2]][Z]] | G[I].g[w[Y][W[3][y]]] | G[I].g[w[Y][W[4][y]]])) ||
                             // Skip for either no conjugate pair digit found in 1st Wing and removal Cells values; or
                !(K[9] = G[I].g[K[4]] & G[I].g[K[5]] & ~(G[I].g[w[K[4]][W[3][y]]] |
                G[I].g[w[K[4]][W[4][y]]] | G[I].g[w[K[5]][W[3][y]]] |
                G[I].g[w[K[5]][W[4][y]]] | G[I].g[Y = w[K[4]][K[11]]] |
                G[I].g[w[Y][W[3][y]]] | G[I].g[w[Y][W[4][y]]])))
                continue;    // No conjugate pair digit found in 2nd Wing and removal Cells values
              if (Y = K[8] & K[9])
        ...
        {                    // Search 2nd Wing Cell position Column wise
          ...
          if (B[G[I].g[K[6] = K[2] - K[0] + K[4]]] == 2 && K[2] > K[0] && K[4] > K[0] &&
            ...
            B[G[I].g[K[0]]] < 3 && !(G[I].g[K[2]] & G[I].g[K[4]]) &&
                             // Apex Cell values < three digits; and no 1st and 2nd Wing Cells common digit; and
            B[G[I].g[K[2]] | G[I].g[K[6]]] == 3 && B[G[I].g[K[4]] | G[I].g[K[6]]] == 3 &&
                             // 1st and 3rd Wing Cells values three digits; and 2nd and 3rd Wing Cells values three digits; and
            !(G[I].g[K[0]] & G[I].g[K[6]]) &&
                             // No Apex and 3rd Wing Cells common digit; and
          ...
          for (y = 0; y < 3; ++y)
          {
            ...
            for (Y = 0; Y < 3; ++Y)
              if (LN1 (w[K[0]][K[7] + y], w[X][K[8] + Y], w[K[4]][K[7] + y], 1) &
                G[I].g[L = w[K[0]][K[8] + Y]] & K[5] ||
                LN1 (w[K[0]][K[8] + y], w[X][K[7] + Y], w[K[2]][K[8] + y], 0) &
                G[I].g[L = w[K[0]][K[7] + Y]] & K[5] || (B[G[I].g[K[0]]] < 3 &&
                (LN1 (w[K[4]][K[7] + y], w[w[K[0]][K[7] + y]][K[8] + Y],
                w[K[0]][K[7] + y], 1) & G[I].g[L = w[K[2]][K[8] + Y]] & K[5] ||
                LN1 (w[K[2]][K[8] + y], w[w[K[0]][K[8] + y]][K[7] + Y],
                w[K[0]][K[8] + y], 0) & G[I].g[L = w[K[4]][K[7] + Y]] & K[5])))
              {              // Line 33, 34, 35, 36
                k[0] = L;
#if RJ > 2
                A[0][0] = X;
            ...
            for (k[18] = Y = 0; Y < 2; ++Y)
            {
              if (LN1 (w[K[0]][K[7] + y], w[M = w[K[4]][K[7] + y]][12 | Y], w[X][K[8]], 1) &
                (G[I].g[w[M][6]] | G[I].g[w[M][7]] | G[I].g[L = w[K[4]][12 | Y]] |
                G[I].g[w[L][6]] | G[I].g[w[L][7]]) & K[5])
              {              // Line 37
                k[0] = w[M][6];
                k[1] = w[M][7];
                k[2] = L;
              ...
              if (LN1 (w[K[0]][K[8] + y], w[M = w[K[2]][K[8] + y]][6 | Y], w[X][K[7]], 0) &
                (G[I].g[w[M][12]] | G[I].g[w[M][13]] | G[I].g[L = w[K[2]][6 | Y]] |
                G[I].g[w[L][12]] | G[I].g[w[L][13]]) & K[5])
              {              // Line 38
                k[0] = w[M][12];
                k[1] = w[M][13];
                k[2] = L;
              ...
              if (LN1 (w[K[4]][K[7] + y], w[M = w[K[0]][K[7] + y]][12 | Y], w[M][K[8]], 1) &
                (G[I].g[w[M][6]] | G[I].g[w[M][7]] | (B[G[I].g[K[0]]] > 2 ? 0 :
              ...
              if (LN1 (w[K[2]][K[8] + y], w[M = w[K[0]][K[8] + y]][6 | Y], w[M][K[7]], 0) &
                (G[I].g[w[M][12]] | G[I].g[w[M][13]] | (B[G[I].g[K[0]]] > 2 ? 0 :
            ...
            if (((N = LN1 (w[K[0]][K[8] + y], w[K[2]][K[8] + y], w[X][K[7]], 0) & K[5]) ||
              ERI (X) & ERI (Z) & K[5]) &&
              ((G[I].g[w[K[0]][12]] | G[I].g[w[K[0]][13]] | G[I].g[w[K[4]][12]] |
              G[I].g[w[K[4]][13]] | (N ? G[I].g[w[X][12]] | G[I].g[w[X][13]] |
              G[I].g[w[Z][12]] | G[I].g[w[Z][13]] : G[I].g[X] | G[I].g[Z] |
              G[I].g[L = w[X][K[7]]] | G[I].g[w[L][6]] | G[I].g[w[L][7]]) |
              G[I].g[w[K[2]][12]] | G[I].g[w[K[2]][13]] | G[I].g[K[6]] |
              G[I].g[w[K[6]][12]] | G[I].g[w[K[6]][13]]) & K[5] ||
              (G[I].g[w[K[0]][6]] | G[I].g[w[K[0]][7]] | G[I].g[w[K[2]][6]] |
              G[I].g[w[K[2]][7]] | G[I].g[w[K[0]][K[7]]] | G[I].g[w[w[K[0]][K[7]]][6]] |
              G[I].g[w[w[K[0]][K[7]]][7]]) & (G[I].g[K[2]] ^ K[5]) ||
              (G[I].g[w[K[0]][12]] | G[I].g[w[K[0]][13]] | G[I].g[w[K[4]][12]] |
              G[I].g[w[K[4]][13]] | G[I].g[X] | G[I].g[w[X][12]] |
              G[I].g[w[X][13]]) & (G[I].g[K[4]] ^ K[5])))
            ...
            if (((N = LN1 (w[K[0]][K[7] + y], w[K[4]][K[7] + y], w[X][K[8]], 1) & K[5]) ||
              ERI (X) & ERI (Z) & K[5]) &&
              ((G[I].g[w[K[0]][6]] | G[I].g[w[K[0]][7]] | G[I].g[w[K[4]][6]] |
              G[I].g[w[K[4]][7]] | (N ? G[I].g[w[X][6]] | G[I].g[w[X][7]] |
              G[I].g[w[Z][6]] | G[I].g[w[Z][7]] : G[I].g[X] | G[I].g[Z] |
              G[I].g[L = w[X][K[8]]] | G[I].g[w[L][12]] | G[I].g[w[L][13]]) |
              G[I].g[w[K[2]][6]] | G[I].g[w[K[2]][7]] | G[I].g[K[6]] |
              G[I].g[w[K[6]][6]] | G[I].g[w[K[6]][7]]) & K[5] ||
              (G[I].g[w[K[0]][6]] | G[I].g[w[K[0]][7]] | G[I].g[w[K[2]][6]] |
              G[I].g[w[K[2]][7]] | G[I].g[X] | G[I].g[w[X][6]] |
              G[I].g[w[X][7]]) & (G[I].g[K[2]] ^ K[5]) ||
              (G[I].g[w[K[0]][12]] | G[I].g[w[K[0]][13]] | G[I].g[w[K[4]][12]] |
              G[I].g[w[K[4]][13]] | G[I].g[w[K[0]][K[8]]] | G[I].g[w[w[K[0]][K[8]]][12]] |
              G[I].g[w[w[K[0]][K[8]]][13]]) & (G[I].g[K[4]] ^ K[5])))
          ...
          if (ERI (K[0]) & K[5] && ((G[I].g[y = w[K[0]][K[7]]] | G[I].g[w[y][6]] |
            G[I].g[w[y][7]] | G[I].g[w[K[2]][6]] | G[I].g[w[K[2]][7]] |
            G[I].g[Y = w[K[0]][K[8]]] | G[I].g[w[Y][12]] | G[I].g[w[Y][13]] |
            G[I].g[w[K[4]][12]] | G[I].g[w[K[4]][13]]) & K[5] ||
            (G[I].g[w[K[0]][6]] | G[I].g[w[K[0]][7]] | G[I].g[w[K[2]][6]] |
            G[I].g[w[K[2]][7]] | G[I].g[y] | G[I].g[w[y][6]] |
            G[I].g[w[y][7]]) & (G[I].g[K[2]] ^ K[5]) ||
            (G[I].g[w[K[0]][12]] | G[I].g[w[K[0]][13]] | G[I].g[w[K[4]][12]] |
            G[I].g[w[K[4]][13]] | G[I].g[Y] | G[I].g[w[Y][12]] |
          ...
          if (B[G[I].g[K[0]]] < 3 && ERI (K[6]) & K[5] && ((G[I].g[y = w[K[4]][K[7]]] |
            G[I].g[w[y][6]] | G[I].g[w[y][7]] | G[I].g[w[K[4]][6]] | G[I].g[w[K[4]][7]] |
            G[I].g[Y = w[K[2]][K[8]]] | G[I].g[w[Y][12]] | G[I].g[w[Y][13]] |
            G[I].g[w[K[2]][12]] | G[I].g[w[K[2]][13]]) & K[5] ||
            (G[I].g[w[K[0]][6]] | G[I].g[w[K[0]][7]] | G[I].g[w[K[2]][6]] |
            G[I].g[w[K[2]][7]] | G[I].g[w[K[0]][K[7]]] | G[I].g[w[w[K[0]][K[7]]][6]] |
            G[I].g[w[w[K[0]][K[7]]][7]]) & (G[I].g[K[2]] ^ K[5]) ||
            (G[I].g[w[K[0]][12]] | G[I].g[w[K[0]][13]] | G[I].g[w[K[4]][12]] |
          ...
          for (y = 0; y < 2; ++y)
          {
            ...
            {                // Box 51, Line 55, 67, Reduced Line Ring 59, 63
              ...
              if (N)
              {
                if (~(G[I].g[w[X][6]] | G[I].g[w[X][7]]) & K[5] &&
                  ...
                  (G[I].g[w[K[0]][6]] | G[I].g[w[K[0]][7]] | G[I].g[w[K[2]][6]] |
                  G[I].g[w[K[2]][7]] | G[I].g[Y = w[K[0]][K[7]]] | G[I].g[w[Y][6]] |
                  G[I].g[w[Y][7]]) & (G[I].g[K[2]] ^ K[5]) ||
                  (G[I].g[w[K[0]][12]] | G[I].g[w[K[0]][13]] | G[I].g[w[K[4]][12]] |
                  G[I].g[w[K[4]][13]] | G[I].g[Y = w[K[0]][K[8]]] |
                  G[I].g[w[Y][12]] | G[I].g[w[Y][13]]) & (G[I].g[K[4]] ^ K[5])))
            ...
            {                // Box 52, Line 56, 68, Reduced Line Ring 60, 64
              ...
              if (N)
              {
                if (~(G[I].g[w[X][12]] | G[I].g[w[X][13]]) & K[5] &&
                  ...
                  (G[I].g[w[K[0]][6]] | G[I].g[w[K[0]][7]] | G[I].g[w[K[2]][6]] |
                  G[I].g[w[K[2]][7]] | G[I].g[Y = w[K[0]][K[7]]] |
                  G[I].g[w[Y][6]] | G[I].g[w[Y][7]]) & (G[I].g[K[2]] ^ K[5]) ||
                  (G[I].g[w[K[0]][12]] | G[I].g[w[K[0]][13]] | G[I].g[w[K[4]][12]] |
                  G[I].g[w[K[4]][13]] | G[I].g[Y = w[K[0]][K[8]]] |
                  G[I].g[w[Y][12]] | G[I].g[w[Y][13]]) & (G[I].g[K[4]] ^ K[5])))
            ...
            if ((N = LB3 (w[K[6]][12 | y], w[K[4]][12 | y], w[Z][K[7]], 0) & K[5]) ||
              (B[G[I].g[K[0]]] < 3 &&
              LB3 (w[K[4]][K[7]], w[X][13 ^ y], w[X][12 | y], 0) & K[5]))
            {                // Box 53, Line 57, 69, Reduced Line 69a, Reduced Line Ring 61, 65
              ...
              else if (~(G[I].g[w[Z][6]] | G[I].g[w[Z][7]]) &
                (G[I].g[K[6]] | G[I].g[w[K[6]][13 ^ y]]) & K[5])
              {
                k[0] = w[K[6]][13 ^ y];
                k[4] = K[6];
              }
              ...
              if (N)
              {
                if (~(G[I].g[w[X][6]] | G[I].g[w[X][7]]) & K[5] &&
                  ...
                  G[I].g[w[K[2]][7]] | G[I].g[Y = w[K[0]][K[7]]] |
                  G[I].g[w[Y][6]] | G[I].g[w[Y][7]]) & (G[I].g[K[2]] ^ K[5]) ||
                  (G[I].g[w[K[4]][12]] | G[I].g[w[K[4]][13]] | G[I].g[w[K[0]][12]] |
                  G[I].g[w[K[0]][13]] | G[I].g[Y = w[K[0]][K[8]]] |
                  G[I].g[w[Y][12]] | G[I].g[w[Y][13]]) & (G[I].g[K[4]] ^ K[5])))
            ...
            if ((N = LB3 (w[K[6]][6 | y], w[K[2]][6 | y], w[Z][K[8]], 1) & K[5]) ||
              (B[G[I].g[K[0]]] < 3 &&
              LB3 (w[K[2]][K[8]], w[X][7 ^ y], w[X][6 | y], 1) & K[5]))
            {                // Box 54, Line 58, 70, Reduced Line 70a, Reduced Line Ring 62, 66
              ...
              else if (~(G[I].g[w[Z][12]] | G[I].g[w[Z][13]]) &
                (G[I].g[K[6]] | G[I].g[w[K[6]][7 ^ y]]) & K[5])
              {
                k[0] = w[K[6]][7 ^ y];
                k[4] = K[6];
              }
              ...
              if (N)
              {
                if (~(G[I].g[w[X][12]] | G[I].g[w[X][13]]) & K[5] &&
                  ...
                  G[I].g[w[M][12]] | G[I].g[w[M][13]] | G[I].g[w[K[2]][12]] |
                  G[I].g[w[K[2]][13]]) | ((G[I].g[w[Z][12]] | G[I].g[w[Z][13]]) & K[5] ? 0 :
...
XYWT1Tf:
              ...
              {
                printf (" %s %s %s %s %s %s",
                  S[k[5]], S[k[10]], S[k[11]], S[k[12]], S[k[13]], S[k[14]]);
                if (k[6] + 1)
                {
                  printf (" %s", S[k[6]]);
                  if (k[7] + 1)
          ...
          if (k[0] = (G[I].g[w[K[0]][6]] | G[I].g[w[K[0]][7]] |
            G[I].g[w[K[2]][6]] | G[I].g[w[K[2]][7]] | G[I].g[w[K[0]][K[7]]] |
            G[I].g[w[K[0]][K[7] + 1]] | G[I].g[w[K[0]][K[7] + 2]]) &
                             // Check Wing Cells common value in Apex and 1st Wing Cells Row removal Cells values; and
            ~(G[I].g[w[K[2]][12]] | G[I].g[w[K[2]][13]] |
            G[I].g[w[K[6]][12]] | G[I].g[w[K[6]][13]] | G[I].g[w[K[2]][K[8]]] |
            G[I].g[w[K[2]][K[8] + 1]] | G[I].g[w[K[2]][K[8] + 2]]) & K[5])
          ...
          if (k[1] = (G[I].g[w[K[0]][12]] | G[I].g[w[K[0]][13]] |
            G[I].g[w[K[4]][12]] | G[I].g[w[K[4]][13]] | G[I].g[w[K[0]][K[8]]] |
            G[I].g[w[K[0]][K[8] + 1]] | G[I].g[w[K[0]][K[8] + 2]]) &
                             // Check Wing Cells common value in Apex and 2nd Wing Cells Column removal Cells values; and
            ~(G[I].g[w[K[4]][6]] | G[I].g[w[K[4]][7]] |
            G[I].g[w[K[6]][6]] | G[I].g[w[K[6]][7]] | G[I].g[w[K[4]][K[7]]] |
            G[I].g[w[K[4]][K[7] + 1]] | G[I].g[w[K[4]][K[7] + 2]]) & K[5])
          ...
          {                  // Search 2nd Wing Cell position Box wise but not in 1st Wing Line
            ...
            if (K[2] > K[0] && K[4] > K[0] &&
              ...
              {              // Search XY-Ring Type 2 3rd Wing Cell position 1st and 2nd Wing Cells common Cell positions wise
                if (B[G[I].g[K[5] = w[K[4]][Y]]] != 2 ||
                  B[G[I].g[K[2]] | G[I].g[K[5]]] != 3 ||
            ...
            if ((G[I].g[w[K[0]][W[3][y]]] | G[I].g[w[K[0]][W[4][y]]] |
              (B[G[I].g[K[0]]] > 2 ? 0 : G[I].g[w[K[4]][K[6]]] |
            ...
            {                // Search XY-Wing Type 2 Transport and XYZ-Wing Transport
              ...
              if (((k[0] = LB3 (M = w[K[4]][N], w[X][K[1]], w[X][K[7]], y) & K[5]) ||
                ...
                ((G[I].g[w[K[2]][W[3][y]]] | G[I].g[w[K[2]][W[4][y]]] |
                G[I].g[w[K[4]][W[3][y]]] | G[I].g[w[K[4]][W[4][y]]] |
                (B[G[I].g[K[0]]] < 3 ? 0 : G[I].g[A = w[K[4]][K[1]]] |
                G[I].g[w[A][W[3][y]]] | G[I].g[w[A][W[4][y]]]) |
                (k[0] && (B[G[I].g[K[0]]] < 3 || w[K[0]][K[8]] == M) &&
                (~(G[I].g[w[X][W[3][y]]] | G[I].g[w[X][W[4][y]]]) & K[5]) ?
                G[I].g[w[X][W[1][!y]]] | G[I].g[w[X][W[18][!y]]] |
                G[I].g[w[X][W[19][!y]]] | G[I].g[w[X][W[20][!y]]] |
                G[I].g[w[X][W[21][!y]]] | G[I].g[w[X][W[22][!y]]] : 0) |
                (k[0] && (~(G[I].g[w[Z][W[3][y]]] | G[I].g[w[Z][W[4][y]]]) & K[5]) ?
                G[I].g[w[Z][W[1][!y]]] | G[I].g[w[Z][W[18][!y]]] |
                G[I].g[w[Z][W[19][!y]]] | G[I].g[w[Z][W[20][!y]]] |
                G[I].g[w[Z][W[21][!y]]] | G[I].g[w[Z][W[22][!y]]] : 0)) & K[5] ||
                (G[I].g[w[K[0]][W[3][y]]] | G[I].g[w[K[0]][W[4][y]]] |
                G[I].g[L = w[K[0]][K[7]]] | G[I].g[w[L][W[3][y]]] |
                G[I].g[w[L][W[4][y]]] | G[I].g[w[K[2]][W[3][y]]] |
                G[I].g[w[K[2]][W[4][y]]]) & (G[I].g[K[2]] ^ K[5]) ||
                (G[I].g[w[K[0]][W[3][y]]] | G[I].g[w[K[0]][W[4][y]]] | G[I].g[M] |
                G[I].g[w[M][W[3][y]]] | G[I].g[w[M][W[4][y]]] |
                G[I].g[w[K[4]][W[3][y]]] | G[I].g[w[K[4]][W[4][y]]] |
                (w[K[0]][K[8]] == M ? G[I].g[w[K[4]][W[1][!y]]] |
              ...
              {              // Line Ring 05, 07, Box Ring 06, 08, Reduced Line Ring 09, 10, 11, 12
                ...
                if (k[0] && ~(G[I].g[w[Y = w[K[2]][K[8]]][W[3][y]]] |
                  G[I].g[w[Y][W[4][y]]]) & K[5])
                ...
                printf ("%d) XY%s Transport:%s%s Ring %d @ r%dc%d %s SL %d @ %s %d\n=> -%d @ r%dc%d r%dc%d",
                  G[I].p, B[G[I].g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing",
                  (k[1] | k[2]) ? " Reduced " : " ", k[0] ? R_C : "Box",
                  b[G[I].g[K[2]] | G[I].g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                  COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]],
                  k[0] ? R_C : "Box", k[0] ? RCN (M) : BOX (M), b[K[5]],
                  ROW (w[w[K[2]][W[3][y]]][20] | w[w[K[2]][W[4][y]]][20]),
                  COL (w[w[K[2]][W[3][y]]][20] | w[w[K[2]][W[4][y]]][20]),
                  ROW (w[w[K[4]][W[3][y]]][20] | w[w[K[4]][W[4][y]]][20]),
                  COL (w[w[K[4]][W[3][y]]][20] | w[w[K[4]][W[4][y]]][20]));
                ...
                if (k[2])
                  printf (" r%dc%d",
                    ...
                    w[w[K[2]][W[19][!y]]][20] | w[w[K[2]][W[20][!y]]][20] |
                    w[w[K[2]][W[21][!y]]][20] | w[w[K[2]][W[22][!y]]][20]));
                printf (" => -%d @ r%dc%d => -%d @ r%dc%d r%dc%d r%dc%d",
                  b[G[I].g[K[2]] ^ K[5]],
                  ROW (w[w[K[0]][W[3][y]]][20] | w[w[K[0]][W[4][y]]][20] |
                  w[w[K[2]][W[3][y]]][20] | w[w[K[2]][W[4][y]]][20] |
              ...
              for (Y = W[1][!y]; Y < W[2][!y]; ++Y)
              {
                ...
                if (((k[0] = LN1 (w[K[2]][Y], w[K[4]][Y], w[Z][K[7]], y) & K[5]) ||
                  ...
                  (G[I].g[w[K[0]][W[3][y]]] | G[I].g[w[K[0]][W[4][y]]] |
                  G[I].g[w[K[0]][K[7]]] | G[I].g[w[K[0]][K[7] + 1]] |
                  G[I].g[w[K[0]][K[7] + 2]] | G[I].g[w[K[2]][W[3][y]]] |
                  G[I].g[w[K[2]][W[4][y]]]) & (G[I].g[K[2]] ^ K[5]) ||
                  (G[I].g[w[K[0]][W[3][y]]] | G[I].g[w[K[0]][W[4][y]]] | G[I].g[M] |
                  G[I].g[w[M][W[3][y]]] | G[I].g[w[M][W[4][y]]] | G[I].g[w[K[4]][W[3][y]]] |
                  G[I].g[w[K[4]][W[4][y]]] | (w[K[0]][K[8]] == M ? (k[0] ?
                  G[I].g[w[Z][W[3][!y]]] | G[I].g[w[Z][W[4][!y]]] : G[I].g[Z]) |
                  G[I].g[w[K[4]][A]] | G[I].g[w[K[4]][A + 1]] |
                ...
                {            // Line Ring 13, 14, ERI Ring 15, 16
                  ...
                  printf ("%d) XY%s Transport: %s Ring %d @ r%dc%d %s SL %s %d between %d @ %s and %d @ %s\n=> -%d @ %s",
                    G[I].p, B[G[I].g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing",
                    k[0] ? R_C : "ERI", b[G[I].g[K[2]] | G[I].g[K[4]]],
                    ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
                    S[K[4]], k[0] ? R_C : "ERI", k[0] ? RCN (X) : BOX (X),
                    b[K[5]], S[X], b[K[5]], S[Z], b[K[5]], S[M]);
                  if (B[G[I].g[K[0]]] < 3 || w[K[0]][K[8]] == M)
                  {
                    if (k[0])
                      printf (" r%dc%d r%dc%d",
                    ...
                    printf (" %s %s %s %s %s %s %s", S[w[K[2]][K[8]]],
                      S[w[K[2]][A]], S[w[w[K[2]][A]][W[3][!y]]],
                      S[w[w[K[2]][A]][W[4][!y]]], S[w[K[4]][A]],
                      S[w[w[K[4]][A]][W[3][!y]]], S[w[w[K[4]][A]][W[4][!y]]]);
                  }
                  ...
                  for (A = 3; A < 5; ++A)
                    ...
                    {        // Line 17, ERI 18
                      ...
                      printf ("%d) XYZ-Wing Transport: %s %d @ r%dc%d %s SL %s %d between%s%d @ %s and%s%d @ %s\n=> -%d @ %s\n",
                        G[I].p, k[0] ? R_C : "ERI", b[G[I].g[K[0]]],
                        ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
                        S[K[4]], k[0] ? R_C : "ERI", k[0] ? RCN (X) : BOX (X),
                        k[29] ? " " : " ERI ", b[K[5]], S[X], k[0] ? " " : " ERI ",
                        b[K[5]], S[Z], b[K[5]], S[L]);
#endif
                      goto START;
                    }
                for (M = 0; M < 2; ++M)
                {
                    ...
                    for (A = K[7]; A < K[7] + 3; ++A)
                      ...
                      {      // Line 19, ERI 20, 21
                        ...
                        printf ("%d) XY%s Transport: %s %d @ r%dc%d %s SL %d @ %s %d => -%d @ %s",
                          ...
                          k[0] ? R_C : "ERI", b[G[I].g[K[2]] | G[I].g[K[4]]],
                          ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
                          S[K[4]], b[K[5]], k[0] ? R_C : "ERI Box",
                          k[0] ? RCN (X) : BOX (X), b[K[5]], S[L]);
                        if (!k[0] && (B[G[I].g[K[0]]] < 3 || w[K[0]][K[8]] == w[K[4]][N]))
                  ...
                  for (A = 3; A < 5; ++A)
                    if (((k[0] = LN1 (w[L = w[K[2 << M]][W[A][y]]][Y],
                      ...
                      G[I].g[w[L][W[4][!y]]]) | (k[0] ?
                      G[I].g[w[w[K[2 << M]][Y]][W[3][!y]]] |
                      G[I].g[w[w[K[2 << M]][Y]][W[4][!y]]] :
                      G[I].g[w[K[2 << M]][Y]]) : 0)) & K[5])
                    {        // Line 22, 24, 26, 28, 30 ERI 23, 25, 27, 29, 31
                      ...
                      printf ("%d) XY%s Transport: %s %d @ r%dc%d %s SL %s %d between %d @ %s and %d @ %s\n=> -%d @ %s",
                        ...
                        ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
                        S[K[4]], k[0] ? R_C : "ERI", k[0] ? RCN (X) : BOX (X),
                        b[K[5]], S[X], b[K[5]], S[Z], b[K[5]], S[L]);
                      if (B[G[I].g[K[0]]] < 3 || w[K[0]][K[8]] == w[K[4]][N])
                      {
                        printf (" %s",
                          S[w[L][M ? N : (B[G[I].g[K[0]]] < 3 ? K[8] : W[3][!y])]]);
                        if (!M && B[G[I].g[K[0]]] > 2)
                          printf (" %s", S[w[L][W[4][!y]]]);
                      }
                      printf (" %s",
                        S[k[0] ? w[w[K[2 << M]][Y]][W[3][!y]] : w[K[2 << M]][Y]]);
                      if (k[0])
            ...
            if (B[G[I].g[K[0]]] > 2 && (G[I].g[w[K[4]][K[6]]] |
              G[I].g[w[K[4]][K[6] + 1]] | G[I].g[w[K[4]][K[6] + 2]]) & K[5])
            {                // Check XYZ-Wing Hybrid for Apex Cell values > two digits; and Wing Cells common value found in XYZ-Wing Hybrid Cells values
              int k[3] = { 0, 0, 0};

              if (~(G[I].g[w[K[4]][K[7]]] | G[I].g[w[K[4]][K[7] + 1]] |
                G[I].g[w[K[4]][K[7] + 2]]) & (G[I].g[X = w[K[0]][K[8]]] |
                G[I].g[w[X][W[3][y]]] | G[I].g[w[X][W[4][y]]] |
              ...
              if ((G[I].g[w[K[0]][K[7]]] | G[I].g[w[K[0]][K[7] + 1]] |
                G[I].g[w[K[0]][K[7] + 2]]) & K[5] &&
                (~(G[I].g[Z = w[K[2]][K[8]]] | G[I].g[w[Z][W[3][y]]] |
                G[I].g[w[Z][W[4][y]]]) & K[5] ||
                ~(G[I].g[Z] | G[I].g[w[K[2]][W[1][!y]]] | G[I].g[w[K[2]][W[18][!y]]] |
                G[I].g[w[K[2]][W[19][!y]]] | G[I].g[w[K[2]][W[20][!y]]] |
                G[I].g[w[K[2]][W[21][!y]]] | G[I].g[w[K[2]][W[22][!y]]]) &
                G[I].g[w[K[4]][K[1]]] & K[5]))
    ...
    {                        // Search WXYZ-Wing Type 1, Almost Locked Set move Type 1a and Type 1b Apex unsolved Cell positions wise
      ...
      {                      // Search 1st Wing Cell position Row wise
        ...
        {                    // Search 2nd Wing Cell position Column wise but not both Wing Cells positions in Apex Box
          if (!G[I].g[K[4] = w[K[0]][K[3]]] ||
            B[G[I].g[K[0]] | G[I].g[K[2]] | G[I].g[K[4]]] > 4)
            ...
            {                // Search 3rd Wing Cell position
              if (!G[I].g[K[6] = w[K[0]][K[5]]] ||
                ...
                B[G[I].g[K[0]] | G[I].g[K[2]] | G[I].g[K[4]] | G[I].g[K[6]]] > 4 ||
                             //  Apex and Wings Cells values > four digits; or
                B[K[7] = G[I].g[K[4 >> Y]] & (G[I].g[K[2 << Y]] | G[I].g[K[6]])] != 1 ||
                             // Wing Cells common value not one digit; or
                (G[I].g[K[0]] & K[7] && !(G[I].g[K[2]] & K[7] && K[1] > 5) &&
                             // Wing Cells common value in Apex Cell values; and
                !(G[I].g[K[4]] & K[7] && K[3] < 14)) ||
              ...
              {              // Check no Wing Cells common value in WXYZ-Wing Type 1 removal Cell values
                ...
                printf ("%d) WXYZ-Wing Type 1: %d @ r%dc%d %s => -%d @ ",
                  ...
                  ROW (w[K[0]][20] | w[K[2 << Y]][20] | w[K[6]][20]), COL (w[K[0]][20] |
                  w[K[2 << Y]][20] | w[K[6]][20]), S[K[4 >> Y]], b[K[7]]);
                if (k[5] + 1)
                {
                  printf ("r%dc%d",
                  ...
                  if (~G[I].g[K[0]] & K[7])
                    printf (" r%dc%d", ROW (w[K[8]][20] | w[w[K[8]][W[3][k[5]]]][20] |
                      S[w[K[8]][W[4][k[5]]]][20]), COL (w[K[8]][20] |
                      w[w[K[8]][W[3][k[5]]]][20] | S[w[K[8]][W[4][k[5]]]][20]));
                  printf ("\n");
                }
                else
                  printf ("%s\n", S[K[8]]);
...
// WXYZ-Wing Type 1 Transport
          ...
          if (B[G[I].g[K[0]]] > 2 && B[G[I].g[K[5] = K[2] - K[0] + K[4]]] == 2 &&
            ...
            B[G[I].g[K[2]] | G[I].g[K[5]]] == 3 && B[G[I].g[K[4]] | G[I].g[K[5]]] == 3 &&
                             // 1st and 3rd Wing Cells values three digits; and 2nd and 3rd Wing Cells values three digits; and
            ((G[I].g[w[K[0]][W[3][Y = B[G[I].g[K[0]] | G[I].g[K[2]]] > 3]]] |
            G[I].g[w[K[0]][W[4][Y]]] | G[I].g[w[y = K[2 << Y]][W[3][Y]]] |
            G[I].g[w[y][W[4][Y]]] |
            G[I].g[w[K[0]][Z = W[K[W[14][Y]] < W[5][Y] ? 5 : 1][Y]]] |
            G[I].g[w[K[0]][Z + 1]] | G[I].g[w[K[0]][Z + 2]]) &
            (K[6] = ~G[I].g[K[5]] & G[I].g[y])))
          ...
          {                  // Search Almost Locked Set move Type 1b 3rd Wing Cell position Line wise
            if (B[G[I].g[K[0]] | G[I].g[K[2 << Y]]] != 3 ||
              B[G[I].g[K[0]] & G[I].g[K[4 >> Y]]] != 1)
    ...
    {                        // Search WXYZ-Wing Type 2a, Type 2b, Type 3, Type 4a, Type 4b, Type 5, Almost Locked Set move Type 2a, Type 2b and Type 2c Apex unsolved Cell positions wise
      ...
      {
        if (!(G[I].g[w[K[0]][W[6][y]]] | G[I].g[w[K[0]][W[7][y]]] |
          G[I].g[w[K[0]][W[8][y]]] | G[I].g[w[K[0]][W[9][y]]] |
          G[I].g[w[K[0]][W[10][y]]] | G[I].g[w[K[0]][W[11][y]]]) ||
          !(G[I].g[w[K[0]][W[1][y]]] | G[I].g[w[K[0]][W[18][y]]] |
          G[I].g[w[K[0]][W[19][y]]] | G[I].g[w[K[0]][W[20][y]]] |
...
// WXYZ-Wing Type 2a, Type 2b and Type 3 Transport
            ...
            for (K[5] = 3; K[5] < 5; ++K[5])
            {                // Search WXYZ-Wing Type 4a, Type 4b and Type 5 (SDC) for 2nd Apex Cell position mini-Line wise
              if (K[0] > (K[6] = w[K[0]][W[K[5]][y]]) || !G[I].g[K[6]] ||
                             // Skip for either 1st Apex Cell position > 2nd Apex Cell position; or 2nd Apex Cell position not unsolved; or
                B[G[I].g[K[0]] | G[I].g[K[2]] | G[I].g[K[4]] | G[I].g[K[6]]] != 4 ||
                ...
                continue;    // No common digit in Apex Cells and 2nd Wing Cell values
              ...
              else
              {
                ...
                if (!(G[I].g[K[2]] & G[I].g[K[4]]) &&
                             // Check WXYZ-Wing Type 5 (SDC) for no common digit in Wing Cells values; and
                  ((G[I].g[K[7] = w[K[0]][W[7 - K[5]][y]]] |
                  G[I].g[w[K[2]][W[3][y]]] | G[I].g[w[K[2]][W[4][y]]] |
                  G[I].g[w[K[0]][W[Z = K[1] == W[6][y] || K[1] == W[7][y] ||
                  K[1] == W[8][y] ? 9 : 6][y]]] | G[I].g[w[K[0]][W[Z + 1][y]]] |
                  G[I].g[w[K[0]][W[Z + 2][y]]]) & G[I].g[K[2]] || (G[I].g[K[7]] |
                  G[I].g[w[K[4]][W[3][y]]] | G[I].g[w[K[4]][W[4][y]]] | G[I].g[w[K[0]][X]] |
                  G[I].g[w[K[0]][X + 1]] | G[I].g[w[K[0]][X + 2]]) & G[I].g[K[4]]))
                {            // WXYZ-Wing Type 5 (SDC) removal Cells values
            ...
            if (B[G[I].g[K[0]]] == 3 && B[G[I].g[K[0]] | G[I].g[K[2]]] == 4 &&
              ...
              {              // Search Almost Locked Set move Type 2c 3rd Wing Cell position 1st Wing Box and 2nd Wing Line wise
                if (B[G[I].g[K[5] = w[K[2]][Y]]] != 2 ||
                  B[G[I].g[K[0]] | G[I].g[K[5]]] != 4 ||
                  B[G[I].g[K[2]] | G[I].g[K[5]]] != 3 || B[G[I].g[K[4]] | G[I].g[K[5]]] != 3)
                  continue;  // 1st and 3rd Wing Cells values not three digits; or 2nd and 3rd Wing Cells values not three digits; or
                if (((B[G[I].g[K[2]]] < 3 ? G[I].g[w[K[4]][W[3][y]]] |
                  G[I].g[w[K[4]][W[4][y]]] : 0) | (B[G[I].g[K[4]]] < 3 ?
                  G[I].g[w[K[2]][W[3][y]]] | G[I].g[w[K[2]][W[4][y]]] : 0)) &
            ...
            if (B[G[I].g[K[0]]] > 3 || B[G[I].g[K[2]]] > 2 || B[G[I].g[K[4]]] > 2 ||
              (G[I].g[K[2]] & G[I].g[K[4]]))
            ...
            {                // Check Almost Locked Set move Type 2a for Apex Cell values three digits
              ...
              {              // Search Almost Locked Set move Type 2a 3rd Wing Cell position 1st Wing Box and 2nd Wing Line wise
                if (!G[I].g[K[5] = w[K[2]][Y]] || B[G[I].g[K[5]]] > 3 ||
                             // Skip for 3rd Wing Cell values not unsolved; or 3rd Wing Cell values > three digits; or
                  B[G[I].g[K[0]] | G[I].g[K[5]]] != 4 ||
                             // Apex and 3rd Wing Cells values not four digits; or
            ...
            {                // Search Almost Locked Set move Type 2b 3rd Wing Cell position 2nd Wing Line wise but not in Box
              if (B[G[I].g[K[5] = w[K[2]][Y]]] != 2 ||
                             // Skip for 3rd Wing Cell values not two digits; or
                B[G[I].g[K[0]] | G[I].g[K[5]]] != 4 ||
                             // Apex and 3rd Wing Cells values not four digits; or
                B[G[I].g[K[2]] | G[I].g[K[5]]] != 3 || B[G[I].g[K[4]] | G[I].g[K[5]]] != 3)
              ...
              if ((G[I].g[K[6] = K[4 | y] - COL (w[K[4 | y]][20]) + COL (w[K[5 - y]][20])] |
                G[I].g[w[K[6]][W[3][y]]] | G[I].g[w[K[6]][W[4][y]]] |
                (B[G[I].g[K[0]]] > 2 ? 0 :
                G[I].g[K[7] = K[5 - y] - COL (w[K[5 - y]][20]) + COL (w[K[4 | y]][20])] |
                G[I].g[w[K[7]][W[3][y]]] | G[I].g[w[K[7]][W[4][y]]])) &
                G[I].g[K[4]] & G[I].g[K[5]])
              {
    ...
    if (a == q)              // All unsolved Cell positions checked
    {
      if (X + 1)             // One Guardian Cell position found
      {
        for (z = 0, Y = G[I].g[X]; y = Y & -Y; Y -= y)
          ...
          if (!(G[I].g[w[X][0]] & y) + !(G[I].g[w[X][1]] & y) +
            !(G[I].g[w[X][2]] & y) + !(G[I].g[w[X][3]] & y) +
            !(G[I].g[w[X][4]] & y) + !(G[I].g[w[X][5]] & y) +
            !(G[I].g[w[X][6]] & y) + !(G[I].g[w[X][7]] & y) < 7 &&
            !(G[I].g[w[X][6]] & y) + !(G[I].g[w[X][7]] & y) +
            !(G[I].g[w[X][8]] & y) + !(G[I].g[w[X][9]] & y) +
            !(G[I].g[w[X][10]] & y) + !(G[I].g[w[X][11]] & y) +
            !(G[I].g[w[X][12]] & y) + !(G[I].g[w[X][13]] & y) < 7 &&
            !(G[I].g[w[X][12]] & y) + !(G[I].g[w[X][13]] & y) +
            !(G[I].g[w[X][14]] & y) + !(G[I].g[w[X][15]] & y) +
            !(G[I].g[w[X][16]] & y) + !(G[I].g[w[X][17]] & y) +
            !(G[I].g[w[X][18]] & y) + !(G[I].g[w[X][19]] & y) < 7)
            z |= y;          // Digit not found in Row, Box or Column wise < seven Cell positions
#if RJ > 2
...
NHSCF:
    ...
    printf ("%d%s) %s: %d @ %s", G[I].p + 1, G[I].p != 10 && !(G[I].p % 10) ? "st" :
      (G[I].p != 11 && G[I].p % 10 == 1 ? "nd" :
      (G[I].p != 12 && G[I].p % 10 == 2 ? "rd" : "th")),
      y ? (y > 1 ? "Trial & Error" : "Hidden single") :
      "Naked single", b[G[I].s[r[G[I].p]]], S[r[G[I].p]]);
    if (y)
    {
      printf (" from values %d", b[G[I].g[r[G[I].p]]]);
      if (y < 2)
        printf (" %s %d wise", Z & 255 ? (Z >> 12 ? "Box" : "Column") : "Row",
          Z & 255 ? (Z >> 12 ? BOX (r[G[I].p]) : COL (w[r[G[I].p]][20])) :
          ROW (w[r[G[I].p]][20]));
    }
    printf ("\n");
#endif
...
int invalid (void)
{
  ...
  for (; p < 81; ++p)
  {
    ...
    if (!G[0].s[p])          // Check unsolved Cell position
    {
      for (a = 1; a < 257; a <<= 1)
        G[0].g[p] |= check (p, a);
                             // Check constraint and assign Cell value for unsolved Cell position digit wise
    ...
    do
    {
      if ((m = fgetc (o)) != 10 && m != EOF && a < 80)
        G[0].s[++a] = (m > 48 && m < 58) << (m - 49);
                             // Assign digit in clue Cell positions
      else if (m == 10 || m == EOF)
      {
#if RJ > 1
        printf ("\n");
