    ...
    {                        // Search W-Wings Type 1 and Type 2 second Cell position unsolved Cell position wise
      ...
      {                      // Check first and second Cell positions eitehr Band or Stack wise
        ...
        {                    // Check Strong Link Line wise
          ...
          g[K[8]] &= ~K[2];
#if RJ > 2
          printf ("%d) Found W-Wings Type 2 %s Cells %d %d Clues %d Strong Link Mini-%s Cells %d %d %d Clue %d drop Clue %d from %d %d %d %d %d %d\n",
          ...
          if (solve (p))
            return 1;
#if RJ > 2
          printf ("%d) Restore W-Wings Type 2 %s Cells %d %d Clues %d Strong Link Mini-%s Cells %d %d %d Clue %d add Clue %d to %d %d %d %d %d %d\n",
            p, X[2][0] ? "Stack" : "Band", K[0], K[1], b[g[K[0]]], X[2][0] ? "Column" : "Row",
            L, w[L][W[3][X[2][0]]], w[L][W[4][X[2][0]]], b[Z], b[g[K[0]] - Z], K[3], K[5], K[6], K[4], K[7], K[8]);
#endif
          g[K[3]] = k[0];
        ...
        {                    // Search W-Wings Type 1 Strong Link Line and ERI wise
          for (K[6] = 0; K[6] < 2; ++K[6])
            for (K[7] = 0; K[7] < 2; ++K[7])
              ...
              {              // Check Strong Link Line wise
                ...
                g[K[4]] &= ~K[2];
#if RJ > 2
                printf ("%d) Found W-Wings Type 1 Grid Cells %d %d Clues %d Strong Link Line between Cells %d %d %d and Cell %d Clue %d drop Clue %d from %d %d\n",
          ...
          {                  // Check Strong Link ERI wise
            ...
            g[K[4]] &= ~K[2];
#if RJ > 2
            printf ("%d) Found W-Wings Type 1 Grid Cells %d %d Clues %d Strong Link ERI Cell %d Clue %d drop Clue %d from %d %d\n",
...
#if RJ > 2
            printf ("%d) Found W-Wings Type %s Cells %d %d Clues %d Strong Link Line between Cell %d and Cell %d Clue %d drop Clue %d from %d ",
...
#if RJ > 2
            printf ("%d) Found W-Wings Type %s Cells %d %d Clues %d Strong Link between ERI Cell %d and ERI Cell %d Clue %d drop Clue %d from %d ",
              p, X[2][0] != X[2][1] ? "1 Grid" : X[2][0] ? "2 Stack" : "2 Band",
              K[0], K[1], b[g[K[0]]], w[K[0]][L], w[K[3 + a]][L], b[Z], b[g[K[0]] - Z], K[3]);
            if (K[5] < 0)
              printf ("%d\n", K[4]);
      ...
      for (y = 0; y < 2; ++y)// Search Strong Link Line wise
        ...
        {                    // Search Strong Link first Cell position Line wise
          ...
          if (!(g[w[K[4]][W[3][1 - y]]] & K[1]) + !(g[w[K[4]][W[4][1 - y]]] & K[1]) +
            ...
            !(g[w[K[4]][W[1][1 - y] + 4]] & K[1]) + !(g[w[K[4]][W[1][1 - y] + 5]] & K[1]) == 1)
          {                  // Check one ERI digit in second Line Cell positions
            printf ("%d) Found Empty Rectangle Intersection Cell %d Strong Link %s between Cell %d and Cell %d drop Clue %d from Cell %d\n",
              p, a, y ? "Row" : "Column", K[4], w[K[2]][W[1][y] + b[~K[3] & 63] - 1], b[K[1]], K[2]);
