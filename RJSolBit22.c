...
#define RJ 1                 // 0 no debugging, 1 print solutions, 2 print puzzles, 3 print steps, 4 print possibilities
...
XYWT1Tf:
  ...
  for (a = p; a < q; ++a)    // Search XY-Ring Type 2, XY-Wing Type 2, XY-Wing Type 2 Transport, XYZ-Wing, XYZ-Wing Transport and XYZ-Wing Hybrid Type 1 and Type 2 Apex unsolved Cell position wise
  {
    if (B[g[r[a]]] > 3)
...
XYWT2Tf:
          ...
          {                  // Search XYZ-Wing Hybrid Type wise
            ...
            g[w[K[0]][A[2]]] &= ~K[5];
#if RJ > 2
            printf ("%d) XYZ-Wing Hybrid Type %d: %d @ %s %s %s %s => -%d @ %s %s %s\n",
              p, 2 - Y, b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], S[w[K[4]][Z]],
              b[K[5]], S[w[K[0]][A[0]]], S[w[K[0]][A[1]]], S[w[K[0]][A[2]]]);
#endif
            if (solve (p))
              return 1;
#if RJ > 2
            printf ("%d) Undo XYZ-Wing Hybrid Type %d: %d @ %s %s %s %s <= +%d @ %s %s %s\n",
              p, 2 - Y, b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], S[w[K[4]][Z]],
              b[K[5]], S[w[K[0]][A[0]]], S[w[K[0]][A[1]]], S[w[K[0]][A[2]]]);
#endif
            g[w[K[0]][A[0]]] = k[0];
            ...
            prn ();
#endif
            return 0;        // Undo XYZ-Wing Hybrid Type 1 and Type 2 exclusion Cells Clues
          }
        }
      }
    }
  }
  for (a = p; a < q; ++a)    // Search WXYZ-Wing Type 1 and Almost Locked Set Type 1 Apex unsolved Cell position wise
  {
...
// WXYZ-Wing Type 1 Transport
        ...
        if (K[1] < 6 && K[3] > 13 &&
                             // Check Almost Locked Set Type 1 1st Wing Cell position not Apex Box; and 2nd Wing Cell position not Apex Box; and
        ...
        {                    // Almost Locked Set Type 1 exclusion Cell Clues
          int k[7] = {g[w[K[0]][W[3][Y]]], g[w[K[0]][W[4][Y]]],
                      g[w[y][W[3][Y]]], g[w[y][W[4][Y]]],
                      g[w[K[0]][Z]], g[w[K[0]][Z + 1]], g[w[K[0]][Z + 2]]};
                             // Backup Almost Locked Set Type 1 exclusion Cell Clues and drop Wing Cells common exclusion Clues
          g[w[K[0]][W[3][Y]]] &= ~K[6];
          g[w[K[0]][W[4][Y]]] &= ~K[6];
          g[w[y][W[3][Y]]] &= ~K[6];
          g[w[y][W[4][Y]]] &= ~K[6];
          ...
          g[w[K[0]][Z + 2]] &= ~K[6];
#if RJ > 2
          printf ("%d) Almost Locked Set Type 1: %d @ %s %s %s %s => -%d @ %s %s %s %s %s %s %s\n",
            p, b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], S[K[5]],
          ...
          if (solve (p))
            return 1;
#if RJ > 2
          printf ("%d) Undo Almost Locked Set Type 1: %d @ %s %s %s %s <= +%d @ %s %s %s %s %s %s %s\n",
            p, b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], S[K[5]],
            b[K[6]], S[w[K[0]][W[3][Y]]], S[w[K[0]][W[4][Y]]],
            S[w[y][W[3][Y]]], S[w[y][W[4][Y]]],
            S[w[K[0]][Z]], S[w[K[0]][Z + 1]], S[w[K[0]][Z + 2]]);
          ...
          prn ();
#endif
          return 0;          // Undo Wing Cells common Clue to Almost Locked Set Type 1 exclusion Cell Clues
        }
      }
    }
  }
...
#if RJ > 2
              printf ("%d) WXYZ-Wing Type 4%c: %d @ %s %s %s %s => -%d @ ",
                p, Z + 1 ? 'a' : 'b', b[g[K[0]] | g[K[2]] | g[K[4]] | g[K[6]]], S[K[0]], S[K[6]], S[K[2]], S[K[4]], b[K[7]]);
              if (Z + 1)
                printf ("%s %s %s %s\n", S[w[K[0]][W[7 - K[5]][y]]], S[w[K[2]][Z]], S[w[K[2]][Z + 1]], S[w[K[2]][Z + 2]]);
              else
                printf ("%s\n", S[w[K[0]][W[7 - K[5]][y]]]);
#endif
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo WXYZ-Wing Type 4%c: %d @ %s %s %s %s <= +%d @ ",
                p, Z + 1 ? 'a' : 'b', b[g[K[0]] | g[K[2]] | g[K[4]] | g[K[6]]], S[K[0]], S[K[6]], S[K[2]], S[K[4]], b[K[7]]);
              if (Z + 1)
                printf ("%s %s %s %s\n", S[w[K[0]][W[7 - K[5]][y]]], S[w[K[2]][Z]], S[w[K[2]][Z + 1]], S[w[K[2]][Z + 2]]);
              else
