...
#define LN33(X, Z, M, y) (g[X] | w[X][W[3][y]] | w[X][W[4][y]]) & \
                         (g[Z] | w[Z][W[3][y]] | w[Z][W[4][y]]) & \
                         ~(g[M] | w[M][W[3][y]] | w[M][W[4][y]])
//#define LN13(X, Z, M, y) g[X] & (g[Z] | w[Z][W[3][y]] | w[Z][W[4][y]]) & \
//                         ~(g[M] | w[M][W[3][y]] | w[M][W[4][y]])
#define LN11(X, Z, M, y) g[X] & g[Z] & ~(w[X][W[3][y]] | w[X][W[4][y]] | \
                         w[Z][W[3][y]] | w[Z][W[4][y]] | \
                         g[M] | w[M][W[3][y]] | w[M][W[4][y]])
          ...
          {                  // Wing Cells common Clue not in Apex Cell Clues
            ...
            {                // (Line 09, 10, ERI 13, 14)
              if (g[L = w[K[0]][K[7] + A]] & K[5])
                for (Y = W[1][!y]; Y < W[2][!y]; ++Y)
                  if ((k[75] = LN11 (X = w[L][Y], Z = w[K[4]][Y], w[K[2]][Y], y) & K[5]) ||
                    (ERI (X) & ERI (Z) & K[5]))
                  {          // (Line 09, ERI 13)
                    k[0] = L;
#if RJ > 2
              ...
              if (~g[L = w[K[4]][K[7] + A]] & K[5])
                continue;
              for (Y = W[1][!y]; Y < W[2][!y]; ++Y)
                if ((k[75] = LN11 (X = w[L][Y], Z = w[K[2]][Y], w[K[4]][Y], y) & K[5]) ||
                  (ERI (X) & ERI (Z) & K[5]))
                {            // (Line 10, ERI 14)
                  k[0] = L;
#if RJ > 2
            ...
            {                // (Line 11, 12, ERI 15, 16, Line Ring 22, ERI Ring 23)
              ...
              {              // (Line 11, 12, ERI 15, 16)
                if (((g[L = w[K[2]][W[A][y]]] | g[w[L][K[8]]] |
                  ...
                  ((k[75] = LN11 (X = w[L][Y], Z = w[K[4]][Y], w[w[K[0]][K[7]]][Y], y) & K[5]) ||
                  (ERI (X) & ERI (Z) & K[5])))
                {            // (Line 11, ERI 15)
                  k[0] = L;
                  k[1] = w[L][K[8]];
                ...
                if (((g[L = w[K[4]][W[A][y]]] | g[w[L][K[8]]] |
                  ...
                  ((k[75] = LN11 (X = w[L][Y], Z = w[K[2]][Y], w[w[K[0]][K[7]]][Y], y) & K[5]) ||
                  (ERI (X) & ERI (Z) & K[5])))
                {            // (Line 12, ERI 16)
                  k[0] = L;
                  k[1] = w[L][K[8]];
              ...
              A = W[Y < W[5][!y] ? 5 : 1][!y];
              if (((k[75] = LN11 (X = w[K[2]][Y], Z = w[K[4]][Y], w[Z][K[7]], y) & K[5]) ||
                (ERI (X) & ERI (Z) & K[5])) &&
            ...
            X = M;
            Z = w[K[2]][K[8]];
            if (((k[75] = LN33 (X, Z, w[M][K[7]], y) & K[5]) ||
              (LN33 (w[K[0]][K[7]], w[K[4]][K[7]], w[M][K[7]], y) & K[5])) &&
