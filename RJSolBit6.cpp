    ...
    for (y = 0; y < 9; ++y)  // Search Basic Fishes for each Candidate
    {
      ...
      {                      // Search X-Wing Candidate for Line 36 pair Cell positions
        ...
        {                    // Restore X-Wing Candidate to opposite Lines other Cell positions
          X = b[K[Z]] - Y + 8;
          g[l[X][h[a][2]]] |= k[h[a][2]] & K[Z] ? J[y] : 0;
          g[l[X][h[a][3]]] |= k[h[a][3]] & K[Z] ? J[y] : 0;
          g[l[X][h[a][4]]] |= k[h[a][4]] & K[Z] ? J[y] : 0;
          g[l[X][h[a][5]]] |= k[h[a][5]] & K[Z] ? J[y] : 0;
          g[l[X][h[a][6]]] |= k[h[a][6]] & K[Z] ? J[y] : 0;
          g[l[X][h[a][7]]] |= k[h[a][7]] & K[Z] ? J[y] : 0;
          g[l[X][h[a][8]]] |= k[h[a][8]] & K[Z] ? J[y] : 0;
        }
        return 0;
      }
