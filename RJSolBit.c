...
/**/
  for (y = p; y < q; ++y)    // Search M-Wings and M-Rings 1st Cell position unsolved Cell positions wise
  {
    if (B[g[r[y]]] > 2)
    ...
    {
      if (w[r[y]][20] & w[r[Y]][20] & 134217727 ||
        B[g[r[Y]]] < 3 || B[g[r[y]] & g[r[Y]]] != 2)
        continue;            // Skip M-Wings and M-Rings for either 1st and 2nd Wing Cell positions Unit wise; or 2nd Wing Cell values < three digits; or 1st and 2nd Wing Cells not two common digits
      ...
      {                      // Check for 1st and 2nd Wing Cell positions not Band and Stack wise
        int K[12] = {r[Y] - COL (w[r[Y]][20]) + COL (w[r[y]][20]),
                    r[y] - COL (w[r[y]][20]) + COL (w[r[Y]][20])},
            k[7] = {r[Y] + (COL (w[r[Y]][20]) < 4 ? (COL (w[r[y]][20]) < 7 ? 6 : 3) :
        ...
        for (K[8] = 0; K[8] < 2; ++K[8])
        {                    // Search 1st Wing Cell 1st digit SL Line wise
          if (!(a = LN1 (r[Y], K[K[8]], k[K[8]], K[8]) & g[r[y]]))
            continue;        // Skip for no 1st digit SL found
          for (K[7] = Z, K[9] = g[r[y]] - a, K[10] = 0; K[10] < 2; ++K[10])
          {                  // Search 1st Wing Cell 2nd digit SL Line wise
            K[2] = K[3] = K[4] = -1;
            k[2] = k[3] = k[4] = k[5] = k[6] = 0;
            if (!(g[w[X][W[3][K[10]]]] & K[9]) + !(g[w[X][W[4][K[10]]]] & K[9]) +
              !(g[K[K[10]]] & K[9]) + !(g[w[K[K[10]]][W[3][K[10]]]] & K[9]) +
              !(g[w[K[K[10]]][W[4][K[10]]]] & K[9]) +
              !(g[k[K[10]]] & K[9]) + !(g[w[k[K[10]]][W[3][K[10]]]] & K[9]) +
              !(g[w[k[K[10]]][W[4][K[10]]]] & K[9]) == 7)
            {                // M-Wing Type 1A, 1B, 1C, 1D, 4A, 4B, 4C, 4D and M-Ring Type A
              if (g[w[X][W[3][K[10]]]] & K[9])
                Z = w[X][W[3][K[10]]];
              else if (g[w[X][W[4][K[10]]]] & K[9])
                Z = w[X][W[4][K[10]]];
              else if (g[K[K[10]]] & K[9])
                Z = K[K[10]];
              else if (g[w[K[K[10]]][W[3][K[10]]]] & K[9])
                Z = w[K[K[10]]][W[3][K[10]]];
              else if (g[w[K[K[10]]][W[4][K[10]]]] & K[9])
                Z = w[K[K[10]]][W[4][K[10]]];
              else if (g[k[K[10]]] & K[9])
                Z = k[K[10]];
              else if (g[w[k[K[10]]][W[3][K[10]]]] & K[9])
                ...
                Z = w[k[K[10]]][W[4][K[10]]];
              if (K[10])
                K[2] = Z - COL (w[Z][20]) + COL (w[r[y]][20]);
              else
                K[2] = r[y] - COL (w[r[y]][20]) + COL (w[Z][20]);
              k[2] = g[K[2]];
              if (w[r[y]][20] & w[K[2]][20] & 261632)
              {              // M-Wing Type 4A, 4B, 4C and 4D
                K[3] = w[K[2]][W[3][!K[10]]];
                K[4] = w[K[2]][W[4][!K[10]]];
                K[5] = w[K[K[10]]][W[3][!K[10]]];
                K[6] = w[K[K[10]]][W[4][!K[10]]];
                k[3] = g[K[3]];
                k[4] = g[K[4]];
                k[5] = g[K[5]];
                k[6] = g[K[6]];
              }
              else if (w[r[y]][20] & w[Z][20] & 134217727)
              {              // M-Ring Type A
                
              }
            }
            else if (~(g[w[r[Y]][W[3][K[10]]]] | g[w[r[Y]][W[4][K[10]]]]) & K[9] &&
              (K[11] = (g[Z = w[r[Y]][W[3][!K[10]]]] | g[w[Z][W[3][K[10]]]] |
              g[w[Z][W[4][K[10]]]]) & K[9]) !=
              ((g[Z = w[r[Y]][W[4][!K[10]]]] | g[w[Z][W[3][K[10]]]] |
              g[w[Z][W[4][K[10]]]]) & K[9]))
            {                // M-Wing Type 2A, Type 2B, Type 2C and Type 2D
              ...
              if (K[10])
                ...
                K[2] = Z - COL (w[Z][20]) + COL (w[r[y]][20]);
              k[2] = g[K[2]];
              if (~(g[w[Z][W[3][K[10]]]] | g[w[Z][W[4][K[10]]]]) & K[9] ||
                (~(g[Z] | g[w[Z][W[3][K[10]]]]) & K[9] && (Z = w[Z][W[4][K[10]]])) ||
                (~(g[Z] | g[w[Z][W[4][K[10]]]]) & K[9] && (Z = w[Z][W[3][K[10]]])))
              {
                if (K[10])
                  K[3] = Z - COL (w[Z][20]) + COL (w[r[y]][20]);
                else
                  K[3] = r[y] - COL (w[r[y]][20]) + COL (w[Z][20]);
                k[3] = g[K[3]];
              }
#if RJ > 2
printf ("%d = %s %s %s / %s %s %s => %d @ %s",
  K[11], S[w[r[Y]][W[3][!K[10]]]], S[w[w[r[Y]][W[3][!K[10]]]][W[3][K[10]]]],
  S[w[w[r[Y]][W[3][!K[10]]]][W[4][K[10]]]], S[w[r[Y]][W[4][!K[10]]]],
  S[w[w[r[Y]][W[4][!K[10]]]][W[3][K[10]]]], S[w[w[r[Y]][W[4][!K[10]]]][W[4][K[10]]]],
  b[k[2]], S[K[2]]);
if (K[3] + 1)
  printf (" %d @ %s", b[k[3]], S[K[3]]);
printf ("\n");
#endif
            }
            else if (LN3 (r[Y], K[K[10]], k[K[10]], K[10]) & K[9])
            {                // M-Wing Type 3A, Type 3B, Type 3C and Type 3D
              K[2] = w[K[K[10]]][W[3][!K[10]]];
              K[3] = w[K[K[10]]][W[4][!K[10]]];
              k[2] = g[K[2]];
              k[3] = g[K[3]];
            }
            else
              continue;
            if (!((k[2] | k[3] | k[4] | k[5] | k[6]) & K[9]))
              continue;
#if RJ > 2
printf ("%d) M-%cing: %d @ %s %s SL %d @ %s %s SL %d @ %s %s",
p, w[r[y]][20] & w[Z][20] & 134217727 ? 'R' : 'W',
b[g[r[y]]], S[r[y]], S[X], b[a], S[X], S[K[7]], b[K[9]], S[X], S[Z]);
if (w[r[y]][20] & w[Z][20] & 134217727 && g[X] - g[r[y]])
  printf (" => -%d @ %s", b[g[X] - g[r[y]]], S[X]);
printf (" => -%d @", b[K[9]]);
if (K[2] + 1)
{
  printf (" %s", S[K[2]]);
...
if (K[4] + 1)
{
  printf (" %s %s %s", S[K[4]], S[K[5]], S[K[6]]);
}
printf ("\n");
#endif
          }
...
NHSCF:
  ...
  {                          // Backup and clear current Cell values and assign current Cell position to each current Cell digits
